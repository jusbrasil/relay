	...
	var GraphQLCompilerContext = function () {
	  ...
	  GraphQLCompilerContext.prototype.replace = function replace(node) {
	    return this._update(this._documents.update(node.name, function (existing) {
	      !existing ?  false ? invariant(false, 'GraphQLCompilerContext: Expected to replace existing node %s, but' + 'one was not found in the context.', node.name) : invariant(false) : void 0;
	      return node;
	    }));
	  };
	  ...
	  GraphQLCompilerContext.prototype.add = function add(node) {
	    return this._update(this._documents.update(node.name, function (existing) {
	      !!existing ?  false ? invariant(false, 'GraphQLCompilerContext: Duplicate document named `%s`. GraphQL ' + 'fragments and roots must have unique names.', node.name) : invariant(false) : void 0;
	      return node;
	    }));
	  };
	  ...
	  GraphQLCompilerContext.prototype.getRoot = function getRoot(name) {
	    var node = this._get(name);
	    !(node.kind === 'Root') ?  false ? invariant(false, 'GraphQLCompilerContext: Expected `%s` to be a root, got `%s`.', name, node.kind) : invariant(false) : void 0;
	    return node;
	  };
	  ...
	  GraphQLCompilerContext.prototype._get = function _get(name) {
	    ...
	    !document ?  false ? invariant(false, 'GraphQLCompilerContext: Unknown document `%s`.', name) : invariant(false) : void 0;
	    return document;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function end(traceIdx) {
	  ...
	  !(trace.ph === 'B') ?  false ? invariant(false, 'Begin trace phase') : invariant(false) : void 0;
	  !(stack.pop() === trace) ?  false ? invariant(false, 'GraphQLCompilerProfiler: The profile trace %s ended before nested traces. ' + 'If it is async, try using Profile.waitFor or Profile.profileWait.', trace.name) : invariant(false) : void 0;
	...
	var Transformer = function () {
	  ...
	  Transformer.prototype._traverse = function _traverse(prevNode) {
	    ...
	    switch (prevNode.kind) {
	      ...
	      case 'Request':
	        ...
	        break;
	      default:
	         true ?  false ? invariant(false, 'GraphQLIRTransformer: Unknown kind `%s`.', prevNode.kind) : invariant(false) : void 0;
	    }
	    return nextNode;
	  };
	  ...
	  Transformer.prototype._traverseChildren = function _traverseChildren(prevNode, pluralKeys, singularKeys) {
	    ...
	    pluralKeys && pluralKeys.forEach(function (key) {
	      ...
	      !Array.isArray(prevItems) ?  false ? invariant(false, 'GraphQLIRTransformer: Expected data for `%s` to be an array, got `%s`.', key, prevItems) : invariant(false) : void 0;
	  ...
	  Transformer.prototype._getState = function _getState() {
	    !this._states.length ?  false ? invariant(false, 'GraphQLIRTransformer: Expected a current state to be set but found none. ' + 'This is usually the result of mismatched number of pushState()/popState() ' + 'calls.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function hasID(schema, type) {
	  var unmodifiedType = getRawType(type);
	  !(unmodifiedType instanceof GraphQLObjectType || unmodifiedType instanceof GraphQLInterfaceType) ?  false ? invariant(false, 'GraphQLSchemaUtils.hasID(): Expected a concrete type or interface, ' + 'got type `%s`.', type) : invariant(false) : void 0;
	...
	function assertTypeWithFields(type) {
	  !(type instanceof GraphQLObjectType || type instanceof GraphQLInterfaceType) ?  false ? invariant(false, 'GraphQLSchemaUtils: Expected type `%s` to be an object or interface type.', type) : invariant(false) : void 0;
	  return type;
	}
	...
	function getTypeFromAST(schema, ast) {
	  ...
	  !isType(type) ?  false ? invariant(false, 'GraphQLSchemaUtils: Unknown type `%s`.', print(ast)) : invariant(false) : void 0;
	  return type;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function print(node) {
	  if (node.kind === 'Fragment') {
	    ...
	    return node.operation + ' ' + node.name + printArgumentDefinitions(node.argumentDefinitions) + printDirectives(node.directives) + printSelections(node, '') + '\n';
	     ...
	     true ?  false ? invariant(false, 'GraphQLIRPrinter: Unsupported IR node `%s`.', node.kind) : invariant(false) : void 0;
	  }
	}
	...
	function printSelection(selection, indent, parentCondition) {
	  ...
	  if (selection.kind === 'LinkedField') {
	    ...
	    // For Flow
	    !(value != null) ?  false ? invariant(false, 'GraphQLIRPrinter: Expected a variable for condition, got a literal `null`.') : invariant(false) : void 0;
	    ...
	    str = subSelections.join('\n' + INDENT);
	     ...
	     true ?  false ? invariant(false, 'GraphQLIRPrinter: Unknown selection kind `%s`.', selection.kind) : invariant(false) : void 0;
	  }
	  return str;
	}
	...
	function printValue(value, type) {
	  ...
	  if (value.kind === 'Variable') {
	    ...
	    !(type instanceof GraphQLInputObjectType) ?  false ? invariant(false, 'GraphQLIRPrinter: Need an InputObject type to print objects.') : invariant(false) : void 0;
	    ...
	    !(type instanceof GraphQLList) ?  false ? invariant(false, 'GraphQLIRPrinter: Need a type in order to print arrays.') : invariant(false) : void 0;
	...
	function printLiteral(value, type) {
	  ...
	  if (type instanceof GraphQLEnumType) {
	    !(typeof value === 'string') ?  false ? invariant(false, 'GraphQLIRPrinter: Expected value of type %s to be a string, got `%s`.', type.name, value) : invariant(false) : void 0;
	    return value;
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getName(ast) {
	  ...
	  !(typeof name === 'string') ?  false ? invariant(false, 'RelayParser: Expected ast node `%s` to have a name.', ast) : invariant(false) : void 0;
	  return name;
	}
	...
	var CodegenDirectory = function () {
	  function CodegenDirectory(dir) {
	    ...
	    if (fs.existsSync(dir)) {
	      !fs.statSync(dir).isDirectory() ?  false ? invariant(false, 'Expected `%s` to be a directory.', dir) : invariant(false) : void 0;
	  ...
	  CodegenDirectory.prototype._addGenerated = function _addGenerated(filename) {
	    !!this._files.has(filename) ?  false ? invariant(false, 'CodegenDirectory: Tried to generate `%s` twice in `%s`.', filename, this._dir) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function generate(node) {
	  !(['Batch', 'Fragment'].indexOf(node.kind) >= 0) ?  false ? invariant(false, 'RelayCodeGenerator: Unknown AST kind `%s`. Source: %s.', node.kind, getErrorMessage(node)) : invariant(false) : void 0;
	...
	var RelayCodeGenVisitor = {
	  leave: {
	    Batch: function Batch(node) {
	      !(node.requests.length !== 0) ?  false ? invariant(false, 'Batch must contain Requests.') : invariant(false) : void 0;
	    ...
	    Condition: function Condition(node, key, parent, ancestors) {
	      !(node.condition.kind === 'Variable') ?  false ? invariant(false, 'RelayCodeGenerator: Expected static `Condition` node to be ' + 'pruned or inlined. Source: %s.', getErrorMessage(ancestors[0])) : invariant(false) : void 0;
	      return {
	        kind: 'Condition',
	    ...
	    Argument: function Argument(node, key, parent, ancestors) {
	      !(['Variable', 'Literal'].indexOf(node.value.kind) >= 0) ?  false ? invariant(false, 'RelayCodeGenerator: Complex argument values (Lists or ' + 'InputObjects with nested variables) are not supported, argument ' + '`%s` had value `%s`. Source: %s.', node.name, JSON.stringify(node.value, null, 2), getErrorMessage(ancestors[0])) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function intersectionTypeAnnotation(types) {
	  !(types.length > 0) ?  false ? invariant(false, 'RelayFlowBabelFactories: cannot create an intersection of 0 types') : invariant(false) : void 0;
	...
	function unionTypeAnnotation(types) {
	  !(types.length > 0) ?  false ? invariant(false, 'RelayFlowBabelFactories: cannot create a union of 0 types') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragment(fragment, state) {
	  ...
	  state.hoistedArgDefs.forEach(function (hoistedArgDef, argName) {
	    ...
	    if (existingArgDef) {
	      !areSameArgumentDefinitions(existingArgDef, hoistedArgDef.argDef) ?  false ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because ' + 'argument `%s` has been declared in `%s` and they are not the same.', hoistedArgDef.source, argName, fragment.name) : invariant(false) : void 0;
	      return;
	    }
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  ...
	  !(fragmentSpread.args.length === 0) ?  false ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` with ' + 'arguments. Use the `ApplyFragmentArgumentTransform` before flattening', fragmentSpread.name) : invariant(false) : void 0;
	  ...
	  }) ?  false ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because it has local ' + 'argument definition.', fragmentSpread.name) : invariant(false) : void 0;
	  ...
	  try {
	    for (var _iterator = fragment.argumentDefinitions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      if (hoistedArgDef) {
	        !areSameArgumentDefinitions(_argDef, hoistedArgDef.argDef) ?  false ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because ' + 'argument `%s` has been declared in `%s` and they are not the same.', hoistedArgDef.source, _argDef.name, fragmentSpread.name) : invariant(false) : void 0;
	        continue;
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function fragmentMetadata(_ref2) {
	  ...
	  !(plural === undefined || typeof plural === 'boolean') ?  false ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "plural" argument to @relay ' + 'to be a boolean literal if specified.') : invariant(false) : void 0;
	...
	function fragmentSpreadMetadata(_ref3) {
	  ...
	  !(mask === undefined || typeof mask === 'boolean') ?  false ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "mask" argument to @relay ' + 'to be a boolean literal if specified.') : invariant(false) : void 0;
	  !(deferrable === undefined || typeof deferrable === 'boolean') ?  false ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "deferrable" argument to ' + '@relay to be a boolean literal if specified.') : invariant(false) : void 0;
	  !!(deferrable === true && mask === false) ?  false ? invariant(false, 'RelayRelayDirectiveTransform: Cannot unmask a deferrable fragment spread.') : invariant(false) : void 0;
	...
	function getIdentifierForSelection(node) {
	  if (node.kind === 'LinkedField' || node.kind === 'ScalarField') {
	    ...
	    return 'C:' + (node.condition.kind === 'Variable' ? '$' + node.condition.variableName : String(node.condition.value)) + String(node.passingValue);
	     ...
	     true ?  false ? invariant(false, 'getIdentifierForSelection: Unexpected kind `%s`.', node.kind) : invariant(false) : void 0;
	  }
	}
	          ...
	          for (var _iterator2 = outputDirectories.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            try {
	              for (var _iterator3 = all[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                ...
	                !_isGeneratedFile(_filePath2) ?  false ? invariant(false, 'CodegenRunner: %s returned false for isGeneratedFile, ' + 'but was in generated directory', _filePath2) : invariant(false) : void 0;
	              }
	            } catch (err) {
	    ...
	    var _ref8 = (0, _asyncToGenerator3.default)(function* (parserName) {
	      ...
	      yield CodegenWatcher.watchCompile(parserConfig.baseDir, parserConfig.watchmanExpression, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter, (() => {
	        var _ref9 = (0, _asyncToGenerator3.default)(function* (files) {
	          !_this6.parsers[parserName] ?  false ? invariant(false, 'Trying to watch an uncompiled parser config: %s', parserName) : invariant(false) : void 0;
	          if (firstChange) {
	            firstChange = false;
	            return;
	          }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function flattenSelections(node, state) {
	  ...
	  !type ?  false ? invariant(false, 'FlattenTransform: Expected parent type.') : invariant(false) : void 0;
	...
	function flattenSelectionsInto(flattenedSelections, node, state, type) {
	  ...
	  node.selections.forEach(function (selection) {
	    ...
	    if (flattenedSelection.kind === 'InlineFragment') {
	      !(selection.kind === 'InlineFragment') ?  false ? invariant(false, 'FlattenTransform: Expected a ScalarField, got a %s', selection.kind) : invariant(false) : void 0;
	      ...
	      !(selection.kind === 'Condition') ?  false ? invariant(false, 'FlattenTransform: Expected a Condition, got a %s', selection.kind) : invariant(false) : void 0;
	      flattenedSelections.set(nodeIdentifier, (0, _extends3['default'])({}, flattenedSelection, {
	      ...
	      !(selection.kind === 'LinkedField') ?  false ? invariant(false, 'FlattenTransform: Expected a LinkedField, got a %s', selection.kind) : invariant(false) : void 0;
	      ...
	      !(selection.kind === 'ScalarField') ?  false ? invariant(false, 'FlattenTransform: Expected a ScalarField, got a %s', selection.kind) : invariant(false) : void 0;
	      // Note: arguments are intentionally reversed to avoid rebuilds
	      assertUniqueArgsForAlias(selection, flattenedSelection);
	      flattenedSelections.set(nodeIdentifier, (0, _extends3['default'])({
	        kind: 'ScalarField'
	       ...
	       true ?  false ? invariant(false, 'FlattenTransform: Unknown kind `%s`.', flattenedSelection.kind) : invariant(false) : void 0;
	    }
	  });
	  return hasFlattened;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLParser = function () {
	  ...
	  GraphQLParser.prototype._recordAndVerifyVariableReference = function _recordAndVerifyVariableReference(name, usedAsType) {
	    ...
	    if (!previousType) {
	      ...
	      !(isTypeSubTypeOf(this._schema, usedAsType, previousType) || isTypeSubTypeOf(this._schema, previousType, usedAsType)) ?  false ? invariant(false, 'GraphQLParser: Variable `$%s` was used in locations expecting ' + 'the conflicting types `%s` and `%s`. Source: %s.', name, previousType, usedAsType, this._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype.transform = function transform() {
	    switch (this._definition.kind) {
	      ...
	      default:
	         true ?  false ? invariant(false, 'GraphQLParser: Unknown AST kind `%s`. Source: %s.', this._definition.kind, this._getErrorContext()) : invariant(false) : void 0;
	    }
	  };
	  ...
	  GraphQLParser.prototype._transformFragment = function _transformFragment(fragment) {
	    ...
	    var _loop = function _loop(_name) {
	      if (_this3._referencedVariableTypesByName.hasOwnProperty(_name)) {
	        ...
	        if (localArgument) {
	          !(variableType == null || isTypeSubTypeOf(_this3._schema, localArgument.type, variableType)) ?  false ? invariant(false, 'GraphQLParser: Variable `$%s` was defined as type `%s`, but used ' + 'in a location that expects type `%s`. Source: %s.', _name, localArgument.type, variableType, _this3._getErrorContext()) : invariant(false) : void 0;
	        } else {
	  ...
	  GraphQLParser.prototype._buildArgumentDefinitions = function _buildArgumentDefinitions(fragment) {
	    ...
	    !(variableDirectives.length === 1) ?  false ? invariant(false, 'GraphQLParser: Directive %s may be defined at most once on fragment ' + '`%s`. Source: %s.', ARGUMENT_DEFINITIONS, getName(fragment), this._getErrorContext()) : invariant(false) : void 0;
	    ...
	    !args.length ?  false ? invariant(false, 'GraphQLParser: Directive %s requires arguments: remove the directive ' + 'to skip defining local variables for this fragment `%s`. Source: %s.', ARGUMENT_DEFINITIONS, getName(fragment), this._getErrorContext()) : invariant(false) : void 0;
	    return args.map(function (arg) {
	      var argName = getName(arg);
	      var argValue = _this4._transformValue(arg.value);
	      !(argValue.kind === 'Literal') ?  false ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed}`, got `%s`. Source: %s.', argValue, _this4._getErrorContext()) : invariant(false) : void 0;
	      var value = argValue.value;
	      !(!Array.isArray(value) && typeof value === 'object' && value !== null && typeof value.type === 'string') ?  false ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got `%s`. Source: %s.', argName, argValue, _this4._getErrorContext()) : invariant(false) : void 0;
	      ...
	      !(unknownKeys.length === 0) ?  false ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got unknown key(s) ' + '`%s`. Source: %s.', argName, unknownKeys.join('`, `'), _this4._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformOperation = function _transformOperation(definition) {
	    ...
	    switch (definition.operation) {
	      ...
	      case 'subscription':
	        ...
	        break;
	      default:
	         true ?  false ? invariant(false, 'GraphQLParser: Unknown AST kind `%s`. Source: %s.', definition.operation, this._getErrorContext()) : invariant(false) : void 0;
	    }
	    !definition.selectionSet ?  false ? invariant(false, 'GraphQLParser: Expected %s `%s` to have selections. Source: %s.', operation, name, this._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArgumentDefinitions = function _transformArgumentDefinitions(argumentDefinitions) {
	    ...
	    return argumentDefinitions.map(function (def) {
	      ...
	      if (_this5._referencedVariableTypesByName.hasOwnProperty(name)) {
	        ...
	        !(variableType == null || isTypeSubTypeOf(_this5._schema, type, variableType)) ?  false ? invariant(false, 'GraphQLParser: Variable `$%s` was defined as type `%s`, but used ' + 'in a location that expects type `%s`. Source: %s.', name, type, variableType, _this5._getErrorContext()) : invariant(false) : void 0;
	      }
	      !(defaultLiteral === null || defaultLiteral.kind === 'Literal') ?  false ? invariant(false, 'GraphQLParser: Expected null or Literal default value, got: `%s`. ' + 'Source: %s.', defaultLiteral && defaultLiteral.kind, _this5._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'LocalArgumentDefinition',
	        metadata: null,
	        name: name,
	    ...
	    return selectionSet.selections.map(function (selection) {
	      ...
	      if (selection.kind === 'Field') {
	        ...
	        node = _this6._transformInlineFragment(selection, parentType);
	         ...
	         true ?  false ? invariant(false, 'GraphQLParser: Unexpected AST kind `%s`. Source: %s.', selection.kind, _this6._getErrorContext()) : invariant(false) : void 0;
	      }
	      ...
	      !(conditionalNodes.length === 1) ?  false ? invariant(false, 'GraphQLParser: Expected exactly one conditional node, got `%s`. ' + 'Source: %s.', conditionalNodes.length, _this6._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformFragmentSpread = function _transformFragmentSpread(fragment, parentType) {
	    ...
	    !(argumentDirectives.length <= 1) ?  false ? invariant(false, 'GraphQLParser: Directive %s may be used at most once in fragment ' + 'spread `...%s`. Source: %s.', ARGUMENTS, fragmentName, this._getErrorContext()) : invariant(false) : void 0;
	    var args = void 0;
	    if (argumentDirectives.length) {
	      args = (argumentDirectives[0].arguments || []).map(function (arg) {
	        var argValue = arg.value;
	        !(argValue.kind === 'Variable') ?  false ? invariant(false, 'GraphQLParser: All @arguments() args must be variables, got %s. ' + 'Source: %s.', argValue.kind, _this7._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformField = function _transformField(field, parentType) {
	    ...
	    !fieldDef ?  false ? invariant(false, 'GraphQLParser: Unknown field `%s` on type `%s`. Source: %s.', name, parentType, this._getErrorContext()) : invariant(false) : void 0;
	    ...
	    if (isLeafType(getNamedType(type))) {
	      !(!field.selectionSet || !field.selectionSet.selections || !field.selectionSet.selections.length) ?  false ? invariant(false, 'GraphQLParser: Expected no selections for scalar field `%s` on type ' + '`%s`. Source: %s.', name, this._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'ScalarField',
	        alias: alias,
	        args: args,
	      ...
	      !(selections && selections.length) ?  false ? invariant(false, 'GraphQLParser: Expected at least one selection for non-scalar field ' + '`%s` on type `%s`. Source: %s.', name, type, this._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'LinkedField',
	        alias: alias,
	        args: args,
	  ...
	  GraphQLParser.prototype._transformHandle = function _transformHandle(fieldName, fieldArgs, clientFieldDirectives) {
	    ...
	    clientFieldDirectives.forEach(function (clientFieldDirective) {
	      ...
	      if (handleArgument) {
	        ...
	        !(maybeHandle.kind === 'Literal' && typeof maybeHandle.value === 'string') ?  false ? invariant(false, 'GraphQLParser: Expected the %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_HANDLE, CLIENT_FIELD, maybeHandle, fieldName, _this8._getErrorContext()) : invariant(false) : void 0;
	        ...
	        if (keyArgument) {
	          ...
	          !(maybeKey.kind === 'Literal' && typeof maybeKey.value === 'string') ?  false ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_KEY, CLIENT_FIELD, maybeKey, fieldName, _this8._getErrorContext()) : invariant(false) : void 0;
	          key = maybeKey.value;
	        }
	        ...
	        if (filtersArgument) {
	          ...
	          })) ?  false ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be an array of ' + 'argument names on field `%s`, but get %s. Source: %s.', CLIENT_FIELD_FILTERS, CLIENT_FIELD, fieldName, maybeFilters, _this8._getErrorContext()) : invariant(false) : void 0;
	          // $FlowFixMe
	  ...
	  GraphQLParser.prototype._transformDirectives = function _transformDirectives(directives) {
	    ...
	    return directives.map(function (directive) {
	      ...
	      !directiveDef ?  false ? invariant(false, 'GraphQLParser: Unknown directive `@%s`. Source: %s.', name, _this9._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArguments = function _transformArguments(args, argumentDefinitions) {
	    ...
	    return args.map(function (arg) {
	      ...
	      !argDef ?  false ? invariant(false, 'GraphQLParser: Unknown argument `%s`. Source: %s.', argName, _this10._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._splitConditions = function _splitConditions(mixedDirectives) {
	    ...
	    mixedDirectives.forEach(function (directive) {
	      if (directive.name === INCLUDE || directive.name === SKIP) {
	        ...
	        !(arg && arg.name === IF) ?  false ? invariant(false, 'GraphQLParser: Expected an `if` argument to @%s. Source: %s.', directive.name, _this11._getErrorContext()) : invariant(false) : void 0;
	        !(arg.value.kind === 'Variable' || arg.value.kind === 'Literal') ?  false ? invariant(false, 'GraphQLParser: Expected the `if` argument to @%s to be a variable. ' + 'Source: %s.', directive.name, _this11._getErrorContext()) : invariant(false) : void 0;
	        conditions.push({
	          kind: 'Condition',
	          condition: arg.value,
	          metadata: null,
	    ...
	    switch (ast.kind) {
	      ...
	      case 'ListValue':
	        ...
	        if (type) {
	          ...
	          // if `type` is a List.
	          !(listType instanceof GraphQLList) ?  false ? invariant(false, 'GraphQLParser: Expected a value matching type `%s`, but ' + 'got a list value. Source: %s.', type, this._getErrorContext()) : invariant(false) : void 0;
	      ...
	      case 'ObjectValue':
	        ...
	        ast.fields.forEach(function (field) {
	          ...
	          if (type) {
	            ...
	            !(objectType instanceof GraphQLInputObjectType) ?  false ? invariant(false, 'GraphQLParser: Expected a value matching type `%s`, but ' + 'got an object value. Source: %s.', type, _this12._getErrorContext()) : invariant(false) : void 0;
	            var fieldConfig = objectType.getFields()[fieldName];
	            !fieldConfig ?  false ? invariant(false, 'GraphQLParser: Unknown field `%s` on type `%s`. Source: %s.', fieldName, type, _this12._getErrorContext()) : invariant(false) : void 0;
	      ...
	      default:
	         true ?  false ? invariant(false, 'GraphQLParser: Unknown ast kind: %s. Source: %s.', ast.kind, this._getErrorContext()) : invariant(false) : void 0;
	    }
	  };
	...
	function assertScalarFieldType(type) {
	  !isScalarFieldType(type) ?  false ? invariant(false, 'Expected %s to be a Scalar Field type.', type) : invariant(false) : void 0;
	  return type;
	}
	...
	function getName(ast) {
	  var name = ast.name ? ast.name.value : null;
	  !(typeof name === 'string') ?  false ? invariant(false, 'GraphQLParser: Expected ast node `%s` to have a name.', ast) : invariant(false) : void 0;
	  return name;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  !(fragmentSpread.args.length === 0) ?  false ? invariant(false, 'InlineFragmentsTransform: Cannot flatten fragment spread `%s` with ' + 'arguments. Use the `ApplyFragmentArgumentTransform` before flattening', fragmentSpread.name) : invariant(false) : void 0;
	  var fragment = this.getContext().getFragment(fragmentSpread.name);
	  var result = {
	    kind: 'InlineFragment',
	    directives: fragmentSpread.directives,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transformCondition(context, fragments, scope, node) {
	  ...
	  !(condition.kind === 'Literal' || condition.kind === 'Variable') ?  false ? invariant(false, 'RelayApplyFragmentArgumentTransform: A non-scalar value was applied to ' + 'an @include or @skip directive, the `if` argument value must be a ' + 'variable or a Boolean, got `%s`.', condition) : invariant(false) : void 0;
	...
	function transformValue(scope, value) {
	  if (value.kind === 'Variable') {
	    ...
	    !(scopeValue != null) ?  false ? invariant(false, 'RelayApplyFragmentArgumentTransform: variable `%s` is not in scope.', value.variableName) : invariant(false) : void 0;
	    return scopeValue;
	  } else if (value.kind === 'ListValue') {
	...
	function transformFragment(context, fragments, parentScope, fragment, args) {
	  ...
	  !(!fragments.has(fragmentName) || fragments.get(fragmentName) !== undefined) ?  false ? invariant(false, 'RelayApplyFragmentArgumentTransform: Found a circular reference from ' + 'fragment `%s`.', fragment.name) : invariant(false) : void 0;
	...
	function hashArguments(args, scope) {
	  ...
	  var printedArgs = JSON.stringify(sortedArgs.map(function (arg) {
	    ...
	    if (arg.value.kind === 'Variable') {
	      ...
	      !(value != null) ?  false ? invariant(false, 'RelayApplyFragmentArgumentTransform: variable `%s` is not in scope.', arg.value.variableName) : invariant(false) : void 0;
	    } else {
	      value = arg.value;
	    }
	    return {
	...
	function getFragmentScope(definitions, args, parentScope) {
	  ...
	  definitions.forEach(function (definition) {
	    if (definition.kind === 'RootArgumentDefinition') {
	      !!argMap.hasOwnProperty(definition.name) ?  false ? invariant(false, 'RelayCompilerScope: Unexpected argument for global variable `%s`. ' + '@arguments may only be provided for variables defined in the ' + "fragment's @argumentDefinitions list.", definition.name) : invariant(false) : void 0;
	      ...
	      if (arg == null || arg.kind === 'Literal' && arg.value == null) {
	        ...
	        // value.
	        !(definition.defaultValue != null || !(definition.type instanceof GraphQLNonNull)) ?  false ? invariant(false, 'RelayCompilerScope: No value found for required argument ' + '`$%s: %s`.', definition.name, definition.type.toString()) : invariant(false) : void 0;
	        fragmentScope[definition.name] = {
	          kind: 'Literal',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitLinkedField(field, options) {
	  ...
	  !(typeof key === 'string') ?  false ? invariant(false, 'RelayConnectionTransform: Expected the %s argument to @%s to ' + 'be a string literal for field %s', KEY, CONNECTION, field.name) : invariant(false) : void 0;
	  var postfix = '' + (field.alias || field.name);
	  !key.endsWith('_' + postfix) ?  false ? invariant(false, 'RelayConnectionTransform: Expected the %s argument to @%s to ' + 'be of form <SomeName>_%s, but get %s. For detailed explanation, check out the dex page ' + 'https://facebook.github.io/relay/docs/pagination-container.html#connection-directive', KEY, CONNECTION, postfix, key) : invariant(false) : void 0;
	...
	function generateConnectionFragment(context, type, direction) {
	  ...
	  !(fragmentAST && fragmentAST.kind === 'FragmentDefinition') ?  false ? invariant(false, 'RelayConnectionTransform: Expected a fragment definition AST.') : invariant(false) : void 0;
	  var fragment = RelayParser.transform(context.clientSchema, fragmentAST);
	  !(fragment && fragment.kind === 'Fragment') ?  false ? invariant(false, 'RelayConnectionTransform: Expected a connection fragment.') : invariant(false) : void 0;
	  return {
	    directives: [],
	    kind: 'InlineFragment',
	    metadata: null,
	...
	function validateConnectionSelection(definitionName, field) {
	  ...
	  !(findArg(field, FIRST) || findArg(field, LAST)) ?  false ? invariant(false, 'RelayConnectionTransform: Expected field `%s: %s` to have a %s or %s ' + 'argument in document `%s`.', field.name, field.type, FIRST, LAST, definitionName) : invariant(false) : void 0;
	  !field.selections.some(function (selection) {
	    return selection.kind === 'LinkedField' && selection.name === EDGES;
	  }) ?  false ? invariant(false, 'RelayConnectionTransform: Expected field `%s: %s` to have a %s ' + 'selection in document `%s`.', field.name, field.type, EDGES, definitionName) : invariant(false) : void 0;
	}
	...
	function validateConnectionType(definitionName, type) {
	  ...
	  !edges ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s field in ' + 'document `%s`.', type, EDGES, definitionName) : invariant(false) : void 0;

	  var edgesType = SchemaUtils.getNullableType(edges.type);
	  !(edgesType instanceof GraphQLList) ?  false ? invariant(false, 'RelayConnectionTransform: Expected `%s` field on type `%s` to be a ' + 'list type in document `%s`.', EDGES, type, definitionName) : invariant(false) : void 0;
	  var edgeType = SchemaUtils.getNullableType(edgesType.ofType);
	  !(edgeType instanceof GraphQLObjectType) ?  false ? invariant(false, 'RelayConnectionTransform: Expected %s field on type `%s` to be a list ' + 'of objects in document `%s`.', EDGES, type, definitionName) : invariant(false) : void 0;

	  var node = edgeType.getFields()[NODE];
	  !node ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s.%s field in ' + 'document `%s`.', type, EDGES, NODE, definitionName) : invariant(false) : void 0;
	  var nodeType = SchemaUtils.getNullableType(node.type);
	  !(nodeType instanceof GraphQLInterfaceType || nodeType instanceof GraphQLUnionType || nodeType instanceof GraphQLObjectType) ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s.%s field' + 'for which the type is an interface, object, or union in document `%s`.', type, EDGES, NODE, definitionName) : invariant(false) : void 0;

	  var cursor = edgeType.getFields()[CURSOR];
	  !(cursor && SchemaUtils.getNullableType(cursor.type) instanceof GraphQLScalarType) ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s.%s field for which the type is a scalar in document `%s`.', type, EDGES, CURSOR, definitionName) : invariant(false) : void 0;

	  var pageInfo = typeFields[PAGE_INFO];
	  !pageInfo ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have a %s field ' + 'in document `%s`.', type, PAGE_INFO, definitionName) : invariant(false) : void 0;
	  var pageInfoType = SchemaUtils.getNullableType(pageInfo.type);
	  !(pageInfoType instanceof GraphQLObjectType) ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have a %s field for ' + 'which the type is an object in document `%s`.', type, PAGE_INFO, definitionName) : invariant(false) : void 0;
	  ...
	  [END_CURSOR, HAS_NEXT_PAGE, HAS_PREV_PAGE, START_CURSOR].forEach(function (fieldName) {
	    ...
	    !(pageInfoField && SchemaUtils.getNullableType(pageInfoField.type) instanceof GraphQLScalarType) ?  false ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s field for which the type is an scalar in document `%s`.', pageInfo.type, fieldName, definitionName) : invariant(false) : void 0;
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createDeferrableReference(context, spread) {
	  ...
	  !doTypesOverlap(schema, fragmentType, nodeType) ?  false ? invariant(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s since objects of ' + 'type %s can never also be of type Node.', spread.name, fragmentType) : invariant(false) : void 0;
	  !(spread.args.length === 0) ?  false ? invariant(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s with arguments.', spread.name) : invariant(false) : void 0;
	...
	function createDeferrableOperation(context, fragment) {
	  ...
	  !queryType ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: "Query" must be a defined type') : invariant(false) : void 0;
	  var nodeField = queryType.getFields().node;
	  !nodeField ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: "Query" must define the field "node"') : invariant(false) : void 0;
	  var idArg = nodeField.args.find(function (arg) {
	    return arg.name === 'id';
	  });
	  !(idArg && isInputType(idArg.type)) ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: "node" field must define the argument "id"') : invariant(false) : void 0;
	...
	function getNodeType(schema) {
	  ...
	  !(nodeType instanceof GraphQLInterfaceType) ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: Schema must define the interface "Node".') : invariant(false) : void 0;
	  return nodeType;
	}
	...
	function getIdType(schema) {
	  ...
	  !idField ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: "Node" must define the field "id"') : invariant(false) : void 0;
	  var idType = getNamedType(idField.type);
	  !isInputType(idType) ?  false ? invariant(false, 'RelayDeferrableFragmentTransform: "Node" must define the scalar field "id"') : invariant(false) : void 0;
	  return idType;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitField(field) {
	  ...
	  !(handles.length === 1) ?  false ? invariant(false, 'RelayFieldHandleTransform: Expected fields to have at most one ' + '"handle" property, got `%s`.', handles.join(', ')) : invariant(false) : void 0;
	  ...
	  RelayFileWriter.prototype.writeAll = function writeAll() {
	    ...
	    return Profiler.asyncContext('RelayFileWriter.writeAll', (0, _asyncToGenerator3.default)(function* () {
	      ...
	      var getDefinitionMeta = function getDefinitionMeta(definitionName) {
	        ...
	        !definitionMeta ?  false ? invariant(false, 'RelayFileWriter: Could not determine source for definition: `%s`.', definitionName) : invariant(false) : void 0;
	      ...
	      try {
	        yield Promise.all(artifacts.map((() => {
	          var _ref3 = (0, _asyncToGenerator3.default)(function* (node) {
	            ...
	            !flowNode ?  false ? invariant(false, 'RelayFileWriter: did not compile flow types for: %s', node.name) : invariant(false) : void 0;
	        ...
	        if (_generateExtraFiles) {
	          Profiler.run('RelayFileWriter:generateExtraFiles', function () {
	            ...
	            _generateExtraFiles(function (dir) {
	              ...
	              !outputDirectory ?  false ? invariant(false, 'RelayFileWriter: cannot generate extra files without specifying ' + 'an outputDir in the config or passing it in.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function parseFile(baseDir, file) {
	  ...
	  !(text.indexOf('graphql') >= 0) ?  false ? invariant(false, 'RelayJSModuleParser: Files should be filtered before passed to the ' + 'parser, got unfiltered file `%s`.', file) : invariant(false) : void 0;
	  ...
	  FindGraphQLTags.memoizedFind(text, baseDir, file, FIND_OPTIONS).forEach(function (template) {
	    ...
	    !ast.definitions.length ?  false ? invariant(false, 'RelayJSModuleParser: Expected GraphQL text to contain at least one ' + 'definition (fragment, mutation, query, subscription), got `%s`.', template) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitField(field, parentType) {
	  ...
	  field.name === SchemaMetaFieldDef.name || field.name === TypeMetaFieldDef.name || field.name === TypeNameMetaFieldDef.name || field.directives.some(function (_ref) {
	    ...
	    !type ?  false ? invariant(false, 'SkipClientFieldTransform: Expected type `%s` to be defined in ' + 'the server schema.', rawType.name) : invariant(false) : void 0;
	...
	function transformNode(node, selectionMap) {
	  ...
	  sortSelections(node.selections).forEach(function (selection) {
	    ...
	    switch (selection.kind) {
	      ...
	      default:
	         true ?  false ? invariant(false, 'SkipRedundantNodesTransform: Unexpected node kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	  });
	...
	function transformNode(context, fragments, node) {
	  ...
	  while (queue.length) {
	    ...
	    switch (selection.kind) {
	      ...
	      default:
	        selection.kind;
	         true ?  false ? invariant(false, 'SkipUnreachableNodeTransform: Unexpected selection kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	    if (nextSelection) {
	      selections = selections || [];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getIdentifierForArgumentValue(value) {
	  switch (value.kind) {
	    ...
	    default:
	       true ?  false ? invariant(false, 'getIdentifierForArgumentValue(): Unsupported AST kind `%s`.', value.kind) : invariant(false) : void 0;
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getLiteralArgumentValues(args) {
	  var values = {};
	  args.forEach(function (arg) {
	    !(arg.value.kind === 'Literal') ?  false ? invariant(false, 'getLiteralArgumentValues(): Expected all args to be literals.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getRelayHandleKey(handleName, key, fieldName) {
	  ...
	  !(fieldName != null) ?  false ? invariant(false, 'getRelayHandleKey: Expected either `fieldName` or `key` in `handle` to be provided') : invariant(false) : void 0;
