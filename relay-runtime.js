...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("babel-runtime/helpers/extends"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/areEqual"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/mapObject"), require("fbjs/lib/removeFromArray"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "babel-runtime/helpers/classCallCheck", "fbjs/lib/warning", "babel-runtime/helpers/extends", "babel-runtime/helpers/defineProperty", "fbjs/lib/areEqual", "babel-runtime/helpers/toConsumableArray", "fbjs/lib/emptyFunction", "fbjs/lib/mapObject", "fbjs/lib/removeFromArray", "fbjs/lib/resolveImmediate", "fbjs/lib/sprintf"], factory);
	else if(typeof exports === 'object')
		exports["RelayRuntime"] = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("babel-runtime/helpers/extends"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/areEqual"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/mapObject"), require("fbjs/lib/removeFromArray"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else
		root["RelayRuntime"] = factory(root["fbjs/lib/invariant"], root["babel-runtime/helpers/classCallCheck"], root["fbjs/lib/warning"], root["babel-runtime/helpers/extends"], root["babel-runtime/helpers/defineProperty"], root["fbjs/lib/areEqual"], root["babel-runtime/helpers/toConsumableArray"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/mapObject"], root["fbjs/lib/removeFromArray"], root["fbjs/lib/resolveImmediate"], root["fbjs/lib/sprintf"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_60__, __WEBPACK_EXTERNAL_MODULE_61__, __WEBPACK_EXTERNAL_MODULE_62__, __WEBPACK_EXTERNAL_MODULE_63__, __WEBPACK_EXTERNAL_MODULE_64__, __WEBPACK_EXTERNAL_MODULE_65__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayConcreteNode = __webpack_require__(4);
	var RelayConnectionHandler = __webpack_require__(13);
	var RelayConnectionInterface = __webpack_require__(21);
	var RelayCore = __webpack_require__(22);
	var RelayDeclarativeMutationConfig = __webpack_require__(8);
	var RelayInMemoryRecordSource = __webpack_require__(9);
	var RelayMarkSweepStore = __webpack_require__(40);
	var RelayModernEnvironment = __webpack_require__(41);
	var RelayModernGraphQLTag = __webpack_require__(24);
	var RelayNetwork = __webpack_require__(43);
	var RelayObservable = __webpack_require__(14);
	var RelayProfiler = __webpack_require__(15);
	var RelayQueryResponseCache = __webpack_require__(45);
	var RelayStoreUtils = __webpack_require__(2);
	var RelayViewerHandler = __webpack_require__(30);

	var applyRelayModernOptimisticMutation = __webpack_require__(50);
	var commitLocalUpdate = __webpack_require__(51);
	var commitRelayModernMutation = __webpack_require__(52);
	var fetchRelayModernQuery = __webpack_require__(53);
	var isRelayModernEnvironment = __webpack_require__(17);
	var recycleNodesInto = __webpack_require__(34);
	var requestRelaySubscription = __webpack_require__(58);
	var simpleClone = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRelayHandleKey = __webpack_require__(33);
	var invariant = __webpack_require__(1);
	var stableCopy = __webpack_require__(35);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var areEqual = __webpack_require__(19);
	...
	function getLinkedRecordID(record, storageKey) {
	  ...
	  !(typeof link === 'object' && link && typeof link[REF_KEY] === 'string') ?  true ? invariant(false, 'RelayModernRecord.getLinkedRecordID(): Expected `%s.%s` to be a linked ID, ' + 'was `%s`.', record[ID_KEY], storageKey, link) : invariant(false) : void 0;
	  return link[REF_KEY];
	}
...
/***/ (function(module, exports, __webpack_require__) {
	      ...
	      for (var _iterator = connectionInfo[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        switch (info.rangeBehavior) {
	          ...
	          case 'prepend':
	            ...
	            break;
	          default:
	             true ? warning(false, 'RelayDeclarativeMutationConfig: RANGE_ADD range behavior `%s` ' + 'will not work as expected in RelayModern, supported range ' + "behaviors are 'append', 'prepend', and 'ignore'.", info.rangeBehavior) : void 0;
	            break;
	        }
	      }
	    } catch (err) {
	...
	function deleteNode(parentID, connectionKeys, pathToConnection, store, deleteIDs) {
	   true ? warning(connectionKeys, 'RelayDeclarativeMutationConfig: RANGE_DELETE must provide a ' + 'connectionKeys') : void 0;
	  var parent = store.get(parentID);
	  if (!parent) {
	    return;
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayRecordState = __webpack_require__(10);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayInMemoryRecordSource = __webpack_require__(9);
	var RelayModernRecord = __webpack_require__(7);
	var RelayResponseNormalizer = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var generateRelayClientID = __webpack_require__(11);
	var getRelayHandleKey = __webpack_require__(33);
	var invariant = __webpack_require__(1);
	var warning = __webpack_require__(5);
	      ...
	      if (args.after != null) {
	        ...
	        if (clientPageInfo && args.after === clientPageInfo.getValue(END_CURSOR)) {
	          ...
	          mergeEdges(_serverEdges, nextEdges, nodeIDs);
	           ...
	           true ? warning(false, 'RelayConnectionHandler: Unexpected after cursor `%s`, edges must ' + 'be fetched from the end of the list (`%s`).', args.after, clientPageInfo && clientPageInfo.getValue(END_CURSOR)) : void 0;
	          return;
	        }
	        ...
	        if (clientPageInfo && args.before === clientPageInfo.getValue(START_CURSOR)) {
	          ...
	          mergeEdges(prevEdges, nextEdges, _nodeIDs);
	           ...
	           true ? warning(false, 'RelayConnectionHandler: Unexpected before cursor `%s`, edges must ' + 'be fetched from the beginning of the list (`%s`).', args.before, clientPageInfo && clientPageInfo.getValue(START_CURSOR)) : void 0;
	          return;
	        }
	      } else {
	...
	function buildConnectionEdge(store, connection, edge) {
	  ...
	  !(typeof edgeIndex === 'number') ?  true ? invariant(false, 'RelayConnectionHandler: Expected %s to be a number, got `%s`.', NEXT_EDGE_INDEX, edgeIndex) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var removeFromArray = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getOperationVariables(operation, variables) {
	  ...
	  operation.argumentDefinitions.forEach(function (def) {
	    ...
	    if (true) {
	       true ? warning(value != null || def.type[def.type.length - 1] !== '!', 'RelayConcreteVariables: Expected a value for non-nullable variable ' + '`$%s: %s` on operation `%s`, got `%s`. Make sure you supply a ' + 'value for all non-nullable arguments.', def.name, def.type, operation.name, JSON.stringify(value)) : void 0;
	    }
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayModernFragmentSpecResolver = __webpack_require__(42);
	  ...
	  if (true) {
	    ...
	    fragmentNames.forEach(function (fragmentName) {
	      var propValue = props[fragmentName];
	       true ? warning(propValue !== undefined, 'createFragmentSpecResolver: Expected prop `%s` to be supplied to `%s`, but ' + 'got `undefined`. Pass an explicit `null` if this is intentional.', fragmentName, containerName) : void 0;
	    });
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayConcreteNode = __webpack_require__(4);
	var RelayRecordSourceMutator = __webpack_require__(28);
	var RelayStoreUtils = __webpack_require__(2);

	var cloneRelayHandleSourceField = __webpack_require__(31);
	var invariant = __webpack_require__(1);
	    ...
	    selections.every(function (selection) {
	      switch (selection.kind) {
	        ...
	        case LINKED_HANDLE:
	          ...
	          break;
	        default:
	          !(selection.kind === SCALAR_FIELD) ?  true ? invariant(false, 'RelayAsyncLoader(): Unexpected ast kind `%s`.', selection.kind) : invariant(false) : void 0;
	      }
	      return !_this2._done;
	    });
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getFragment(taggedNode) {
	  ...
	  !(typeof fragment === 'object' && fragment !== null && fragment.kind === RelayConcreteNode.FRAGMENT) ?  true ? invariant(false, 'RelayModernGraphQLTag: Expected a fragment, got `%s`.', JSON.stringify(fragment)) : invariant(false) : void 0;
	  return fragment;
	}

	function getRequest(taggedNode) {
	  var request = getNode(taggedNode);
	  !(typeof request === 'object' && request !== null && (request.kind === RelayConcreteNode.REQUEST || request.kind === RelayConcreteNode.BATCH_REQUEST)) ?  true ? invariant(false, 'RelayModernGraphQLTag: Expected an request, got `%s`.', JSON.stringify(request)) : invariant(false) : void 0;
	  return request;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createOperationSelector(request, variables, operationFromBatch) {
	  var operation = operationFromBatch || (request.kind === RelayConcreteNode.BATCH_REQUEST ? request.requests[0].operation : request.operation);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getSelector(operationVariables, fragment, item) {
	  ...
	  if (typeof dataID === 'string' && typeof fragments === 'object' && fragments !== null && typeof fragments[fragment.name] === 'object' && fragments[fragment.name] !== null) {
	   ...
	   true ? warning(false, 'RelayModernSelector: Expected object to contain data for fragment `%s`, got ' + '`%s`. Make sure that the parent operation/fragment included fragment ' + '`...%s` without `@relay(mask: false)`.', fragment.name, JSON.stringify(item), fragment.name) : void 0;
	  return null;
	}
	  ...
	  for (var _key in fragments) {
	    if (fragments.hasOwnProperty(_key)) {
	      ...
	      if (item == null) {
	        ...
	        !Array.isArray(item) ?  true ? invariant(false, 'RelayModernSelector: Expected value for key `%s` to be an array, got `%s`. ' + 'Remove `@relay(plural: true)` from fragment `%s` to allow the prop to be an object.', _key, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
	        selectors[_key] = getSelectorList(operationVariables, fragment, item);
	      } else {
	        !!Array.isArray(item) ?  true ? invariant(false, 'RelayModernFragmentSpecResolver: Expected value for key `%s` to be an object, got `%s`. ' + 'Add `@relay(plural: true)` to fragment `%s` to allow the prop to be an array of items.', _key, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
	  ...
	  for (var _key2 in fragments) {
	    if (fragments.hasOwnProperty(_key2)) {
	      ...
	      if (item == null) {
	        ...
	        !Array.isArray(item) ?  true ? invariant(false, 'RelayModernSelector: Expected value for key `%s` to be an array, got `%s`. ' + 'Remove `@relay(plural: true)` from fragment `%s` to allow the prop to be an object.', _key2, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
	        ids[_key2] = getDataIDs(fragment, item);
	      } else {
	        !!Array.isArray(item) ?  true ? invariant(false, 'RelayModernFragmentSpecResolver: Expected value for key `%s` to be an object, got `%s`. ' + 'Add `@relay(plural: true)` to fragment `%s` to allow the prop to be an array of items.', _key2, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
	    ...
	    if (fragments.hasOwnProperty(_key3)) {
	      var _ret = function () {
	        ...
	        if (item == null) {
	          ...
	          !Array.isArray(item) ?  true ? invariant(false, 'RelayModernSelector: Expected value for key `%s` to be an array, got `%s`. ' + 'Remove `@relay(plural: true)` from fragment `%s` to allow the prop to be an object.', _key3, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
	          ...
	          !!Array.isArray(item) ?  true ? invariant(false, 'RelayModernFragmentSpecResolver: Expected value for key `%s` to be an object, got `%s`. ' + 'Add `@relay(plural: true)` to fragment `%s` to allow the prop to be an array of items.', _key3, JSON.stringify(item), fragment.name) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayReader = function () {
	  ...
	  RelayReader.prototype._createFragmentPointer = function _createFragmentPointer(fragmentSpread, record, data, variables) {
	    ...
	    !(typeof fragmentPointers === 'object' && fragmentPointers) ?  true ? invariant(false, 'RelayReader: Expected fragment spread data to be an object, got `%s`.', fragmentPointers) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function convertFetch(fn) {
	  return function fetch(request, variables, cacheConfig, uploadables) {
	    ...
	    return RelayObservable.from(result).map(function (value) {
	...
	function convertToExecutePayload(request, variables, value) {
	  if (!value.data && !value.errors && value.response) {
	    if (!value.operation) {
	       true ? warning(false, 'ConvertToExecuteFunction: execute payload contains response but ' + 'is missing operation.') : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createError(type, name, format, args) {
	  var error = new Error(sprintf.apply(undefined, [format].concat((0, _toConsumableArray3['default'])(args))));
	  error.name = name;
	  error.type = type;
	  error.framesToPop = 2;
	  return error;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayDataLoader = __webpack_require__(23);
	var RelayModernRecord = __webpack_require__(7);
	var RelayProfiler = __webpack_require__(15);
	var RelayReader = __webpack_require__(27);
	var RelayReferenceMarker = __webpack_require__(48);

	var deepFreeze = __webpack_require__(16);
	var hasOverlappingIDs = __webpack_require__(54);
	var recycleNodesInto = __webpack_require__(34);
	var resolveImmediate = __webpack_require__(64);
	...
	var RelayMarkSweepStore = function () {
	  ...
	  RelayMarkSweepStore.prototype.check = function check(selector) {
	    return RelayDataLoader.check(this._recordSource, this._recordSource, selector, []);
	  };
	  ...
	  RelayMarkSweepStore.prototype._updateSubscription = function _updateSubscription(subscription) {
	    ...
	    var _RelayReader$read = RelayReader.read(this._recordSource, snapshot),
	        data = _RelayReader$read.data,
	        seenRecords = _RelayReader$read.seenRecords;

	    var nextData = recycleNodesInto(snapshot.data, data);
	  ...
	  RelayMarkSweepStore.prototype._gc = function _gc() {
	    ...
	    this._roots.forEach(function (selector) {
	      RelayReferenceMarker.mark(_this5._recordSource, selector, references);
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCore = __webpack_require__(22);
	var RelayDataLoader = __webpack_require__(23);
	var RelayDefaultHandlerProvider = __webpack_require__(38);
	var RelayInMemoryRecordSource = __webpack_require__(9);
	var RelayPublishQueue = __webpack_require__(44);

	var deferrableFragmentKey = __webpack_require__(32);
	var invariant = __webpack_require__(1);
	var normalizePayload = __webpack_require__(57);
	var normalizeRelayPayload = __webpack_require__(12);
	var warning = __webpack_require__(5);
	...
	var RelayModernEnvironment = function () {
	  ...
	  RelayModernEnvironment.prototype.isSelectorLoading = function isSelectorLoading(selector) {
	    var key = deferrableFragmentKey(selector.dataID, selector.node.name, selector.variables);
	  ...
	  RelayModernEnvironment.prototype.execute = function execute(_ref2) {
	    ...
	    return this._network.execute(operation.node, operation.variables, cacheConfig || {})['do']({
	      next: function next(executePayload) {
	        var responsePayload = normalizePayload(executePayload);
	        ...
	        if (executePayload.isOptimistic) {
	          !(optimisticResponse == null) ?  true ? invariant(false, 'environment.execute: only support one optimistic respnose per ' + 'execute.') : invariant(false) : void 0;
	          optimisticResponse = {
	            source: source,
	            fieldPayloads: fieldPayloads
	          };
	          ...
	          if (executePayload.operation.kind === 'DeferrableOperation') {
	            var fragmentKey = deferrableFragmentKey(executePayload.variables[executePayload.operation.rootFieldVariable], executePayload.operation.fragmentName, executePayload.variables);
	  ...
	  RelayModernEnvironment.prototype.executeMutation = function executeMutation(_ref3) {
	    ...
	    return this._network.execute(operation.node, operation.variables, { force: true }, uploadables)['do']({
	      ...
	      next: function next(payload) {
	        ...
	        _this4._publishQueue.commitPayload(operation, normalizePayload(payload), updater);
	        _this4._publishQueue.run();
	      },
	  ...
	  RelayModernEnvironment.prototype.sendQuery = function sendQuery(_ref4) {
	    var cacheConfig = _ref4.cacheConfig,
	     ...
	     true ? warning(false, 'environment.sendQuery() is deprecated. Update to the latest ' + 'version of react-relay, and use environment.execute().') : void 0;
	  ...
	  RelayModernEnvironment.prototype.sendMutation = function sendMutation(_ref6) {
	    var onCompleted = _ref6.onCompleted,
	     ...
	     true ? warning(false, 'environment.sendMutation() is deprecated. Update to the latest ' + 'version of react-relay, and use environment.executeMutation().') : void 0;
	  ...
	  RelayModernEnvironment.prototype.sendSubscription = function sendSubscription(_ref7) {
	    var onCompleted = _ref7.onCompleted,
	     ...
	     true ? warning(false, 'environment.sendSubscription() is deprecated. Update to the latest ' + 'version of react-relay, and use environment.execute().') : void 0;
	    return this.execute({
	      operation: operation,
	      updater: updater,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var isScalarAndEqual = __webpack_require__(56);
	      ...
	      if (selectors.hasOwnProperty(_key4)) {
	        ...
	        if (selector == null) {
	          ...
	          if (resolver == null) {
	            ...
	            !(resolver instanceof SelectorListResolver) ?  true ? invariant(false, 'RelayModernFragmentSpecResolver: Expected prop `%s` to always be an array.', _key4) : invariant(false) : void 0;
	          ...
	          if (resolver == null) {
	            ...
	            !(resolver instanceof SelectorResolver) ?  true ? invariant(false, 'RelayModernFragmentSpecResolver: Expected prop `%s` to always be an object.', _key4) : invariant(false) : void 0;
	...
	function create(fetchFn, subscribeFn) {
	  ...
	  function execute(request, variables, cacheConfig, uploadables) {
	    if (request.operationKind === 'subscription') {
	      !observeSubscribe ?  true ? invariant(false, 'RelayNetwork: This network layer does not support Subscriptions. ' + 'To use Subscriptions, provide a custom network layer.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayReader = __webpack_require__(27);
	var RelayRecordSourceMutator = __webpack_require__(28);
	var RelayRecordSourceProxy = __webpack_require__(47);
	var RelayRecordSourceSelectorProxy = __webpack_require__(29);
	...
	var RelayPublishQueue = function () {
	  ...
	  RelayPublishQueue.prototype._applyUpdates = function _applyUpdates() {
	    ...
	    if (this._pendingOptimisticUpdates.size || this._pendingBackupRebase && this._appliedOptimisticUpdates.size) {
	      ...
	      var store = new RelayRecordSourceProxy(mutator, this._handlerProvider);
	        ...
	        this._appliedOptimisticUpdates.forEach(function (optimisticUpdate) {
	          if (optimisticUpdate.operation) {
	            ...
	            var selectorData = void 0,
	                _source = void 0;
	            if (response) {
	              var _normalizeRelayPayloa = normalizeRelayPayload(_operation.root, response);
	        ...
	        this._pendingOptimisticUpdates.forEach(function (optimisticUpdate) {
	          if (optimisticUpdate.operation) {
	            ...
	            var selectorData = void 0,
	                _source3 = void 0;
	            if (response) {
	              var _normalizeRelayPayloa2 = normalizeRelayPayload(_operation2.root, response);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayRecordProxy = function () {
	  ...
	  RelayRecordProxy.prototype.setLinkedRecord = function setLinkedRecord(record, name, args) {
	    !(record instanceof RelayRecordProxy) ?  true ? invariant(false, 'RelayRecordProxy#setLinkedRecord(): Expected a record, got `%s`.', record) : invariant(false) : void 0;
	    var storageKey = getStableStorageKey(name, args);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayModernRecord = __webpack_require__(7);
	var RelayRecordProxy = __webpack_require__(46);
	var RelayRecordSourceSelectorProxy = __webpack_require__(29);
	...
	var RelayRecordSourceProxy = function () {
	  ...
	  RelayRecordSourceProxy.prototype.getRoot = function getRoot() {
	    ...
	    !(root && root.getType() === ROOT_TYPE) ?  true ? invariant(false, 'RelayRecordSourceProxy#getRoot(): Expected the source to contain a ' + 'root record.') : invariant(false) : void 0;
	    return root;
	  };
	    ...
	    selections.forEach(function (selection) {
	      if (selection.kind === LINKED_FIELD) {
	        ...
	        if (typeName != null && typeName === selection.type) {
	         ...
	         true ?  true ? invariant(false, 'RelayReferenceMarker(): Unexpected fragment spread `...%s`, ' + 'expected all fragments to be inlined.', selection.name) : invariant(false) : void 0;
	        ...
	        !(selection.kind === SCALAR_FIELD || selection.kind === SCALAR_HANDLE) ?  true ? invariant(false, 'RelayReferenceMarker(): Unexpected ast kind `%s`.', selection.kind) : invariant(false) : void 0;
	      }
	    });
	  };
	...
	var RelayResponseNormalizer = function () {
	  ...
	  RelayResponseNormalizer.prototype._traverseSelections = function _traverseSelections(node, record, data) {
	    ...
	    node.selections.forEach(function (selection) {
	      if (selection.kind === SCALAR_FIELD || selection.kind === LINKED_FIELD) {
	        ...
	        var value = RelayModernRecord.getValue(record, selection.storageKey);
	        !(typeof value === 'string') ?  true ? invariant(false, 'expected ID at %s', selection.storageKey) : invariant(false) : void 0;
	        ...
	        var key = deferrableFragmentKey(value, selection.name, variables);
	  ...
	  RelayResponseNormalizer.prototype._validateRecordType = function _validateRecordType(record, field, payload) {
	    var typeName = field.concreteType || this._getRecordType(payload);
	     true ? warning(RelayModernRecord.getType(record) === typeName, 'RelayResponseNormalizer: Invalid record `%s`. Expected %s to be ' + 'be consistent, but the record was assigned conflicting types `%s` ' + 'and `%s`. The GraphQL server likely violated the globally unique ' + 'id requirement by returning the same id for different objects.', RelayModernRecord.getDataID(record), TYPENAME_KEY, RelayModernRecord.getType(record), typeName) : void 0;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function applyRelayModernOptimisticMutation(environment, config) {
	  !isRelayModernEnvironment(environment) ?  true ? invariant(false, 'commitRelayModernMutation: expect `environment` to be an instance of ' + '`RelayModernEnvironment`.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	environment, config) {
	  ...
	  if (typeof optimisticResponse === 'function') {
	    optimisticResponse = optimisticResponse();
	     true ? warning(false, 'commitRelayModernMutation: Expected `optimisticResponse` to be an object, ' + 'received a function.') : void 0;
	  }
	  if (optimisticResponse && mutation.fragment.selections && mutation.fragment.selections.length === 1 && mutation.fragment.selections[0].kind === 'LinkedField') {
	    var mutationRoot = mutation.fragment.selections[0].name;
	     true ? warning(optimisticResponse[mutationRoot], 'commitRelayModernMutation: Expected `optimisticResponse` to be wrapped ' + 'in mutation name `%s`', mutationRoot) : void 0;
	  }
	  if (configs) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function fetchRelayModernQuery(environment, taggedNode, variables, cacheConfig) {
	  !environment.unstable_internal ?  true ? invariant(false, 'fetchRelayModernQuery: Expected a valid Relay environment, got `%s`.', environment) : invariant(false) : void 0;
	  var _environment$unstable = environment.unstable_internal,
	      createOperationSelector = _environment$unstable.createOperationSelector,
	      getRequest = _environment$unstable.getRequest;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayError = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function requestRelaySubscription(environment, config) {
	  ...
	  var operation = createOperationSelector(subscription, variables);
	   ...
	   true ? warning(!(config.updater && configs), 'requestRelaySubscription: Expected only one of `updater` and `configs` to be provided') : void 0;

	  var _ref = configs ? RelayDeclarativeMutationConfig.convert(configs, subscription, null /* optimisticUpdater */
