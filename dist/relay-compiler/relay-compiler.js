...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompiler = __webpack_require__(29);
	var RelayFileWriter = __webpack_require__(63);
	var RelayIRTransforms = __webpack_require__(68);
	var RelayJSModuleParser = __webpack_require__(69);

	var formatGeneratedModule = __webpack_require__(76);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ASTCache = __webpack_require__(21);
	var ASTConvert = __webpack_require__(44);
	var AutoAliasTransform = __webpack_require__(45);
	var CodegenDirectory = __webpack_require__(46);
	var CodegenRunner = __webpack_require__(47);
	var DotGraphQLParser = __webpack_require__(49);
	var FilterDirectivesTransform = __webpack_require__(23);
	var FlattenTransform = __webpack_require__(24);
	var GraphQLCompiler = __webpack_require__(51);
	var GraphQLCompilerContext = __webpack_require__(7);
	var GraphQLConsoleReporter = __webpack_require__(52);
	var GraphQLIRPrinter = __webpack_require__(14);
	var GraphQLIRTransformer = __webpack_require__(9);
	var GraphQLIRTransforms = __webpack_require__(53);
	var GraphQLIRVisitor = __webpack_require__(26);
	var GraphQLMultiReporter = __webpack_require__(54);
	var GraphQLParser = __webpack_require__(55);
	var GraphQLSchemaUtils = __webpack_require__(10);
	var GraphQLValidator = __webpack_require__(27);
	var GraphQLWatchmanClient = __webpack_require__(15);
	var SkipClientFieldTransform = __webpack_require__(34);
	var SkipRedundantNodesTransform = __webpack_require__(35);
	var SkipUnreachableNodeTransform = __webpack_require__(36);
	var StripUnusedVariablesTransform = __webpack_require__(74);

	var filterContextForNode = __webpack_require__(17);
	var getIdentifierForArgumentValue = __webpack_require__(37);
	var getLiteralArgumentValues = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ImmutableList = immutable.List,
	    ImmutableOrderedMap = immutable.OrderedMap,
	...
	var GraphQLCompilerContext = function () {
	  ...
	  GraphQLCompilerContext.prototype.add = function add(node) {
	    !!this._documents.has(node.name) ?  true ? invariant(false, 'GraphQLCompilerContext: Duplicate document named `%s`. GraphQL ' + 'fragments and roots must have unique names.', node.name) : invariant(false) : void 0;
	  ...
	  GraphQLCompilerContext.prototype.getRoot = function getRoot(name) {
	    var record = this._documents.get(name);
	    var node = record && record.get('node');
	    !(node && node.kind === 'Root') ?  true ? invariant(false, 'GraphQLCompilerContext: Expected `%s` to be a root, got `%s`.', name, node && node.kind) : invariant(false) : void 0;
	    return node;
	  };
	  ...
	  GraphQLCompilerContext.prototype._get = function _get(name) {
	    var record = this._documents.get(name);
	    !record ?  true ? invariant(false, 'GraphQLCompilerContext: Unknown document `%s`.', name) : invariant(false) : void 0;
	    return record;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var nullthrows = __webpack_require__(80);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var watchman = __webpack_require__(87);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  ...
	  !(fragmentSpread.args.length === 0) ?  true ? invariant(false, 'RelayMaskTransform: Cannot flatten fragment spread `%s` with ' + 'arguments. Use the `ApplyFragmentArgumentTransform` before flattening', fragmentSpread.name) : invariant(false) : void 0;
	  var fragment = this.getContext().get(fragmentSpread.name);
	  !(fragment && fragment.kind === 'Fragment') ?  true ? invariant(false, 'RelayMaskTransform: Unknown fragment `%s`.', fragmentSpread.name) : invariant(false) : void 0;
	  var result = {
	    kind: 'InlineFragment',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function filterContextForNode(node, context) {
	  var queue = [node];
	  var filteredContext = new GraphQLCompilerContext(context.schema).add(node);
	  var visitorConfig = {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transform(context, schema) {
	  return GraphQLIRTransformer.transform(context, { Directive: visitDirective }, function () {
	    return schema;
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var areEqual = __webpack_require__(75);
	var getIdentifierForSelection = __webpack_require__(38);
	var invariant = __webpack_require__(1);
	var stableJSONStringify = __webpack_require__(18);
	...
	function transform(context, options) {
	  ...
	  return context.documents().reduce(function (ctx, node) {
	    ...
	    !(flattenedNode.kind === 'Root' || flattenedNode.kind === 'Fragment') ?  true ? invariant(false, 'FlattenTransform: Expected Root `%s` to flatten back to a Root ' + ' or Fragment.', node.name) : invariant(false) : void 0;
	  ...
	  return (0, _extends3['default'])({}, state.node, {
	    selections: Object.keys(state.selections).map(function (key) {
	      ...
	      if (selectionState.kind === 'FragmentSpread' || selectionState.kind === 'ScalarField') {
	        ...
	        !(_node.kind !== 'Root' && _node.kind !== 'Fragment') ?  true ? invariant(false, 'FlattenTransform: got a `%s`, expected a selection.', _node.kind) : invariant(false) : void 0;
	        return _node;
	      } else {
	         true ?  true ? invariant(false, 'FlattenTransform: Unexpected kind `%s`.', selectionState.kind) : invariant(false) : void 0;
	      }
	    })
	  });
	}
	  ...
	  node.selections.forEach(function (selection) {
	    ...
	    if (selection.kind === 'Condition' || selection.kind === 'InlineFragment') {
	      ...
	      if (!_selectionState) {
	        ...
	        !(_selectionState.node.kind === 'LinkedField' || _selectionState.node.kind === 'ScalarField') ?  true ? invariant(false, 'FlattenTransform: Expected a Field, got %s.', _selectionState.node.kind) : invariant(false) : void 0;
	      ...
	      state.selections[nodeIdentifier] = field;
	       ...
	       true ?  true ? invariant(false, 'FlattenTransform: Unknown kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  ...
	  var fragment = this.getContext().get(fragmentSpread.name);
	  !(fragment && fragment.kind === 'Fragment') ?  true ? invariant(false, 'InlineFragmentsTransform: Unknown fragment `%s`.', fragmentSpread.name) : invariant(false) : void 0;
	  var result = {
	    kind: 'InlineFragment',
	    directives: fragmentSpread.directives,
	    metadata: fragmentSpread.metadata,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitField(field, state) {
	  ...
	  field.name === SchemaMetaFieldDef.name || field.name === TypeMetaFieldDef.name || field.name === TypeNameMetaFieldDef.name || field.directives.some(function (_ref) {
	    ...
	    !type ?  true ? invariant(false, 'SkipClientFieldTransform: Expected type `%s` to be defined in ' + 'the original schema.', rawType.name) : invariant(false) : void 0;
	...
	function visitFragmentSpread(spread, state) {
	  ...
	  !(fragment && fragment.kind === 'Fragment') ?  true ? invariant(false, 'SkipClientFieldTransform: Expected a fragment named `%s` to be defined.', spread.name) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLCompilerContext = __webpack_require__(7);
	var IMap = __webpack_require__(13).Map;
	  ...
	  while (queue.length) {
	    ...
	    if (selection.kind === 'Condition') {
	      ...
	      if (!fragments.has(selection.name)) {
	        ...
	        !(fragment && fragment.kind === 'Fragment') ?  true ? invariant(false, 'SkipUnreachableNodeTransform: Found a reference to undefined ' + 'fragment `%s`.', selection.name) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getIdentifierForArgumentValue = __webpack_require__(37);
	var invariant = __webpack_require__(1);
	var murmurHash = __webpack_require__(40);
	var stableJSONStringify = __webpack_require__(18);
	...
	function transformSelections(nodeSelections) {
	  return nodeSelections.map(function (selection) {
	    if (selection.kind === 'LinkedField') {
	      ...
	      !!selection.args.length ?  true ? invariant(false, 'AutoAliasTransform: Expected arguments to fragment spread ' + '`%s` to be inlined.', selection.name) : invariant(false) : void 0;
	      return selection;
	    } else {
	       true ?  true ? invariant(false, 'AutoAliasTransform: Unexpected node kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	  });
	}
	    ...
	    var _ref6 = (0, _asyncToGenerator3.default)(function* (writerName) {
	      ...
	      try {
	        var combineChanges = function combineChanges(accessor) {
	          var combined = [];
	          !outputDirectories ?  true ? invariant(false, 'CodegenRunner: Expected outputDirectories to be set') : invariant(false) : void 0;
	    ...
	    var _ref8 = (0, _asyncToGenerator3.default)(function* (parserName) {
	      ...
	      yield CodegenWatcher.watchCompile(parserConfig.baseDir, parserConfig.watchmanExpression, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter, (() => {
	        var _ref9 = (0, _asyncToGenerator3.default)(function* (files) {
	          !_this5.parsers[parserName] ?  true ? invariant(false, 'Trying to watch an uncompiled parser config: %s', parserName) : invariant(false) : void 0;
	          if (firstChange) {
	            firstChange = false;
	            return;
	          }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompilerCache = __webpack_require__(58);

	var babylon = __webpack_require__(86);
	var getModuleName = __webpack_require__(78);
	...
	var GraphQLCompiler = function () {
	  ...
	  GraphQLCompiler.prototype.compile = function compile() {
	    ...
	    queryContext.documents().forEach(function (node) {
	      ...
	      var text = filterContextForNode(printContext.getRoot(name), printContext).documents().map(GraphQLIRPrinter.print).join('\n');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FilterDirectivesTransform = __webpack_require__(23);
	var FlattenTransform = __webpack_require__(24);
	var InlineFragmentsTransform = __webpack_require__(28);
	var RelayMaskTransform = __webpack_require__(16);
	var SkipClientFieldTransform = __webpack_require__(34);
	var SkipRedundantNodesTransform = __webpack_require__(35);
	var SkipUnreachableNodeTransform = __webpack_require__(36);

	// Transforms applied to fragments used for reading data from a store
	var FRAGMENT_TRANSFORMS = [RelayMaskTransform.transform, function (ctx) {
	...
	var QUERY_TRANSFORMS = [SkipClientFieldTransform.transform, SkipUnreachableNodeTransform.transform];

	// Transforms applied to the code used to process a query response.
	var CODEGEN_TRANSFORMS = [InlineFragmentsTransform.transform, function (ctx) {
	  return FlattenTransform.transform(ctx, {
	    flattenAbstractTypes: true
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var partitionArray = __webpack_require__(89);
	...
	var GraphQLParser = function () {
	  ...
	  GraphQLParser.prototype._recordVariableReference = function _recordVariableReference(name, type) {
	    ...
	    if (type && prevType) {
	      !(this._referencedVariables[name] == null || isTypeSubTypeOf(this._schema, this._referencedVariables[name], type)) ?  true ? invariant(false, 'GraphQLParser: Variable `$%s` was used in locations expecting ' + 'the conflicting types `%s` and `%s`. Source: %s.', name, prevType, type, this._getErrorContext()) : invariant(false) : void 0;
	    }
	  ...
	  GraphQLParser.prototype._transformFragment = function _transformFragment(fragment) {
	    ...
	    var _loop = function _loop(_name) {
	      if (_this2._referencedVariables.hasOwnProperty(_name)) {
	        ...
	        if (localArgument) {
	          !(variableType == null || isTypeSubTypeOf(_this2._schema, localArgument.type, variableType)) ?  true ? invariant(false, 'GraphQLParser: Variable `$%s` was defined as type `%s`, but used ' + 'in a location that expects type `%s`. Source: %s.', _name, localArgument.type, variableType, _this2._getErrorContext()) : invariant(false) : void 0;
	        } else {
	  ...
	  GraphQLParser.prototype._buildArgumentDefinitions = function _buildArgumentDefinitions(fragment) {
	    ...
	    return args.map(function (arg) {
	      ...
	      !(argValue.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed}`, got `%s`. Source: %s.', argValue, _this3._getErrorContext()) : invariant(false) : void 0;
	      var value = argValue.value;
	      !(!Array.isArray(value) && typeof value === 'object' && value !== null && typeof value.type === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got `%s`. Source: %s.', argName, argValue, _this3._getErrorContext()) : invariant(false) : void 0;
	      ...
	      !(unknownKeys.length === 0) ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got unknown key(s) ' + '`%s`. Source: %s.', argName, unknownKeys.join('`, `'), _this3._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArgumentDefinitions = function _transformArgumentDefinitions(argumentDefinitions) {
	    ...
	    return argumentDefinitions.map(function (def) {
	      ...
	      !(defaultLiteral === null || defaultLiteral.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected null or Literal default value, got: `%s`. ' + 'Source: %s.', defaultLiteral && defaultLiteral.kind, _this4._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'LocalArgumentDefinition',
	        metadata: null,
	        name: name,
	    ...
	    return selectionSet.selections.map(function (selection) {
	      ...
	      if (selection.kind === 'Field') {
	        ...
	        node = _this5._transformInlineFragment(selection, parentType);
	         ...
	         true ?  true ? invariant(false, 'GraphQLParser: Unexpected AST kind `%s`. Source: %s.', selection.kind, _this5._getErrorContext()) : invariant(false) : void 0;
	      }
	      ...
	      !(conditionalNodes.length === 1) ?  true ? invariant(false, 'GraphQLParser: Expected exactly one conditional node, got `%s`. ' + 'Source: %s.', conditionalNodes.length, _this5._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformFragmentSpread = function _transformFragmentSpread(fragment, parentType) {
	    ...
	    if (argumentDirectives.length) {
	      args = (argumentDirectives[0].arguments || []).map(function (arg) {
	        ...
	        !(argValue.kind === 'Variable') ?  true ? invariant(false, 'GraphQLParser: All @arguments() args must be variables, got %s. ' + 'Source: %s.', argValue.kind, _this6._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformHandle = function _transformHandle(fieldName, fieldArgs, clientFieldDirectives) {
	    ...
	    clientFieldDirectives.forEach(function (clientFieldDirective) {
	      ...
	      if (handleArgument) {
	        ...
	        !(maybeHandle.kind === 'Literal' && typeof maybeHandle.value === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected the %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_HANDLE, CLIENT_FIELD, maybeHandle, fieldName, _this7._getErrorContext()) : invariant(false) : void 0;
	        ...
	        if (keyArgument) {
	          ...
	          !(maybeKey.kind === 'Literal' && typeof maybeKey.value === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_KEY, CLIENT_FIELD, maybeKey, fieldName, _this7._getErrorContext()) : invariant(false) : void 0;
	          key = maybeKey.value;
	        }
	        ...
	        if (filtersArgument) {
	          ...
	          })) ?  true ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be an array of ' + 'argument names on field `%s`, but get %s. Source: %s.', CLIENT_FIELD_FILTERS, CLIENT_FIELD, fieldName, maybeFilters, _this7._getErrorContext()) : invariant(false) : void 0;
	          // $FlowFixMe
	  ...
	  GraphQLParser.prototype._transformDirectives = function _transformDirectives(directives) {
	    ...
	    return directives.map(function (directive) {
	      ...
	      !directiveDef ?  true ? invariant(false, 'GraphQLParser: Unknown directive `@%s`. Source: %s.', name, _this8._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArguments = function _transformArguments(args, argumentDefinitions) {
	    ...
	    return args.map(function (arg) {
	      ...
	      !argDef ?  true ? invariant(false, 'GraphQLParser: Unknown argument `%s`. Source: %s.', argName, _this9._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._splitConditions = function _splitConditions(mixedDirectives) {
	    ...
	    mixedDirectives.forEach(function (directive) {
	      if (directive.name === INCLUDE || directive.name === SKIP) {
	        ...
	        !(arg && arg.name === IF) ?  true ? invariant(false, 'GraphQLParser: Expected an `if` argument to @%s. Source: %s.', directive.name, _this10._getErrorContext()) : invariant(false) : void 0;
	        !(arg.value.kind === 'Variable' || arg.value.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected the `if` argument to @%s to be a variable. ' + 'Source: %s.', directive.name, _this10._getErrorContext()) : invariant(false) : void 0;
	        conditions.push({
	          kind: 'Condition',
	          condition: arg.value,
	          metadata: null,
	      ...
	      case 'ObjectValue':
	        ...
	        ast.fields.forEach(function (field) {
	          ...
	          if (type) {
	            ...
	            !(objectType instanceof GraphQLInputObjectType) ?  true ? invariant(false, 'GraphQLParser: Expected a value matching type `%s`, but ' + 'got an object value. Source: %s.', type, _this11._getErrorContext()) : invariant(false) : void 0;
	            var fieldConfig = objectType.getFields()[fieldName];
	            !fieldConfig ?  true ? invariant(false, 'GraphQLParser: Unknown field `%s` on type `%s`. Source: %s.', fieldName, type, _this11._getErrorContext()) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompilerScope = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var formatStorageKey = __webpack_require__(77);
	var invariant = __webpack_require__(1);
	// TODO T21875029 ../../relay-runtime/util/prettyStringify
	var prettyStringify = __webpack_require__(41);
	...
	function generate(node) {
	  !(['Root', 'Fragment'].indexOf(node.kind) >= 0) ?  true ? invariant(false, 'RelayCodeGenerator: Unknown AST kind `%s`. Source: %s.', node.kind, getErrorMessage(node)) : invariant(false) : void 0;
	...
	var RelayCodeGenVisitor = {
	  leave: {
	    ...
	    Argument: function Argument(node, key, parent, ancestors) {
	      !(['Variable', 'Literal'].indexOf(node.value.kind) >= 0) ?  true ? invariant(false, 'RelayCodeGenerator: Complex argument values (Lists or ' + 'InputObjects with nested variables) are not supported, argument ' + '`%s` had value `%s`. Source: %s.', node.name, prettyStringify(node.value), getErrorMessage(ancestors[0])) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayParser = __webpack_require__(32);
	...
	function visitLinkedField(field, options) {
	  ...
	  !definitionName ?  true ? invariant(false, 'RelayConnectionTransform: Transform error, expected a name to have ' + 'been set by the parent operation or fragment definition.') : invariant(false) : void 0;
	...
	function validateConnectionType(definitionName, type) {
	  ...
	  if (!(nodeType instanceof GraphQLInterfaceType || nodeType instanceof GraphQLUnionType || nodeType instanceof GraphQLObjectType)) {
	     true ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s.%s field' + 'for which the type is an interface, object, or union in document `%s`.', type, EDGES, NODE, definitionName) : invariant(false) : void 0;
	  }

	  var cursor = edgeType.getFields()[CURSOR];
	  if (!cursor || !(SchemaUtils.getNullableType(cursor.type) instanceof GraphQLScalarType)) {
	     true ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s.%s field for which the type is a scalar in document `%s`.', type, EDGES, CURSOR, definitionName) : invariant(false) : void 0;
	  }
	  ...
	  if (!(pageInfoType instanceof GraphQLObjectType)) {
	     true ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have a %s field for ' + 'which the type is an object in document `%s`.', type, PAGE_INFO, definitionName) : invariant(false) : void 0;
	  }
	  ...
	  [END_CURSOR, HAS_NEXT_PAGE, HAS_PREV_PAGE, START_CURSOR].forEach(function (fieldName) {
	    ...
	    if (!pageInfoField || !(SchemaUtils.getNullableType(pageInfoField.type) instanceof GraphQLScalarType)) {
	       true ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s field for which the type is an scalar in document `%s`.', pageInfo.type, fieldName, definitionName) : invariant(false) : void 0;
	    }
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRelayHandleKey = __webpack_require__(79);
	var invariant = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompiler = __webpack_require__(29);
	var RelayFlowGenerator = __webpack_require__(64);
	var RelayParser = __webpack_require__(32);
	var RelayValidator = __webpack_require__(72);

	var invariant = __webpack_require__(1);
	var path = __webpack_require__(8);
	var writeRelayGeneratedFile = __webpack_require__(82);
	    ...
	    var _ref = (0, _asyncToGenerator3.default)(function* () {
	      ...
	      if (this._config.outputDir) {
	        ...
	        this._documents.forEach(function (doc, filePath) {
	          doc.definitions.forEach(function (def) {
	            if (isOperationDefinitionAST(def) && def.name) {
	              definitionDirectories.set(def.name.value, path.join(_this._config.baseDir, path.dirname(filePath)));
	            }
	          });
	        });
	      }
	      ...
	      [].concat((0, _toConsumableArray3['default'])(RelayValidator.LOCAL_RULES), (0, _toConsumableArray3['default'])(RelayValidator.GLOBAL_RULES)), RelayParser.transform.bind(RelayParser));

	      var compilerContext = new CompilerContext(extendedSchema);
	      var compiler = new RelayCompiler(this._baseSchema, compilerContext, this._config.compilerTransforms, generate);
	      ...
	      var getGeneratedDirectory = function getGeneratedDirectory(definitionName) {
	        ...
	        !definitionDir ?  true ? invariant(false, 'RelayFileWriter: Could not determine source directory for definition: %s', definitionName) : invariant(false) : void 0;
	        var generatedPath = path.join(definitionDir, '__generated__');
	      ...
	      var transformedFlowContext = RelayFlowGenerator.flowTransforms.reduce(function (ctx, transform) {
	      ...
	      try {
	        yield Promise.all(transformedFlowContext.documents().map((() => {
	          var _ref2 = (0, _asyncToGenerator3.default)(function* (node) {
	            ...
	            var flowTypes = RelayFlowGenerator.generate(node, _this._config.customScalars, _this._config.inputFieldWhiteListForFlow);

	            var compiledNode = compiledDocumentMap.get(node.name);
	            !compiledNode ?  true ? invariant(false, 'RelayCompiler: did not compile definition: %s', node.name) : invariant(false) : void 0;
	            yield writeRelayGeneratedFile(getGeneratedDirectory(compiledNode.name), getGeneratedNode(compiledNode), _this._config.formatModule, flowTypes, _this._config.persistQuery, _this._config.platform, _this._config.relayRuntimeModule || 'relay-runtime');
	          });
	...
	function getGeneratedNode(compiledNode) {
	  !(typeof compiledNode === 'object' && compiledNode !== null && (compiledNode.kind === 'Fragment' || compiledNode.kind === 'Batch')) ?  true ? invariant(false, 'getGeneratedNode: Expected a GeneratedNode, got `%s`.', JSON.stringify(compiledNode)) : invariant(false) : void 0;
	  return compiledNode;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function generateInputVariablesType(node, customScalars, inputFieldWhiteList) {
	  return exportType(node.name + 'Variables', exactObjectTypeAnnotation(node.argumentDefinitions.map(function (arg) {
	    var property = t.objectTypeProperty(t.identifier(arg.name), transformInputType(arg.type, customScalars, inputFieldWhiteList));
	...
	var FLOW_TRANSFORMS = [RelayMaskTransform.transform, function (ctx) {
	  return FlattenTransform.transform(ctx, {});
	}];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transformScalarType(type, customScalars, objectProps) {
	  if (type instanceof GraphQLNonNull) {
	    ...
	    return t.nullableTypeAnnotation(transformNonNullableScalarType(type, objectProps, customScalars));
	  }
	}
	...
	function transformGraphQLEnumType(type) {
	  ...
	  return t.unionTypeAnnotation(type.getValues().map(function (_ref) {
	...
	function transformInputType(type, customScalars, inputFieldWhiteList) {
	  if (type instanceof GraphQLNonNull) {
	    ...
	    return t.nullableTypeAnnotation(transformNonNullableInputType(type, customScalars, inputFieldWhiteList));
	  }
	}
	...
	function transformNonNullableInputType(type, customScalars, inputFieldWhiteList) {
	  if (type instanceof GraphQLList) {
	    ...
	    var props = Object.keys(fields).map(function (key) {
	      ...
	      var property = t.objectTypeProperty(t.identifier(field.name), transformInputType(field.type, customScalars, inputFieldWhiteList));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InlineFragmentsTransform = __webpack_require__(28);
	var RelayApplyFragmentArgumentTransform = __webpack_require__(56);
	var RelayConnectionTransform = __webpack_require__(61);
	var RelayFieldHandleTransform = __webpack_require__(62);
	var RelayGenerateIDFieldTransform = __webpack_require__(66);
	var RelayGenerateTypeNameTransform = __webpack_require__(67);
	var RelayMaskTransform = __webpack_require__(16);
	var RelayRelayDirectiveTransform = __webpack_require__(70);
	var RelaySkipHandleFieldTransform = __webpack_require__(71);
	var RelayViewerHandleTransform = __webpack_require__(73);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FindGraphQLTags = __webpack_require__(50);
	var GraphQL = __webpack_require__(2);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragment(fragment) {
	  ...
	  !(plural === undefined || typeof plural === 'boolean') ?  true ? invariant(false, 'RelayRelayDirectiveTransform: Expected the %s argument to @%s to be ' + 'a boolean literal or not specified.', PLURAL, RELAY) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transformRoot(context, root) {
	  ...
	  var newContext = GraphQLIRTransformer.transform(filterContextForNode(root, context), {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var stableJSONStringify = __webpack_require__(81);
	...
	let writeRelayGeneratedFile = (() => {
	  var _ref = (0, _asyncToGenerator3.default)(function* (codegenDir, generatedNode, formatModule, flowText, persistQuery, platform, relayRuntimeModule) {
	    ...
	    if (generatedNode.kind === 'Batch') {
	      ...
	      !text ?  true ? invariant(false, 'codegen-runner: Expected query to have text before persisting.') : invariant(false) : void 0;
