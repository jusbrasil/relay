  ...
  RelayFileWriter.prototype.writeAll = (() => {
    var _ref = (0, _asyncToGenerator3.default)(function* () {
      ...
      var getGeneratedDirectory = function getGeneratedDirectory(definitionName) {
        ...
        !definitionDir ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayFileWriter: Could not determine source directory for definition: %s', definitionName) : invariant(false) : void 0;
      ...
      try {
        yield Promise.all(transformedFlowContext.documents().map((() => {
          var _ref2 = (0, _asyncToGenerator3.default)(function* (node) {
            ...
            !compiledNode ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayCompiler: did not compile definition: %s', node.name) : invariant(false) : void 0;
...
function getGeneratedNode(compiledNode) {
  !(typeof compiledNode === 'object' && compiledNode !== null && (compiledNode.kind === 'Fragment' || compiledNode.kind === 'Batch')) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'getGeneratedNode: Expected a GeneratedNode, got `%s`.', JSON.stringify(compiledNode)) : invariant(false) : void 0;
  return compiledNode;
}
