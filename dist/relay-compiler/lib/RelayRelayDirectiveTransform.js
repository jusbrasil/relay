...
function visitFragment(fragment) {
  ...
  !(plural === undefined || typeof plural === 'boolean') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayRelayDirectiveTransform: Expected the %s argument to @%s to be ' + 'a boolean literal or not specified.', PLURAL, RELAY) : invariant(false) : void 0;
