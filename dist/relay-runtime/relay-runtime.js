...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "babel-runtime/helpers/classCallCheck", "fbjs/lib/warning", "babel-runtime/helpers/extends", "fbjs/lib/areEqual", "babel-runtime/helpers/defineProperty", "babel-runtime/helpers/toConsumableArray", "fbjs/lib/emptyFunction", "fbjs/lib/removeFromArray", "fbjs/lib/resolveImmediate", "fbjs/lib/sprintf"], factory);
	else if(typeof exports === 'object')
		exports["RelayRuntime"] = factory(require("fbjs/lib/invariant"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else
		root["RelayRuntime"] = factory(root["fbjs/lib/invariant"], root["babel-runtime/helpers/classCallCheck"], root["fbjs/lib/warning"], root["babel-runtime/helpers/extends"], root["fbjs/lib/areEqual"], root["babel-runtime/helpers/defineProperty"], root["babel-runtime/helpers/toConsumableArray"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/removeFromArray"], root["fbjs/lib/resolveImmediate"], root["fbjs/lib/sprintf"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_58__, __WEBPACK_EXTERNAL_MODULE_59__, __WEBPACK_EXTERNAL_MODULE_60__, __WEBPACK_EXTERNAL_MODULE_61__, __WEBPACK_EXTERNAL_MODULE_62__, __WEBPACK_EXTERNAL_MODULE_63__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayConnectionHandler = __webpack_require__(12);
	var RelayConnectionInterface = __webpack_require__(22);
	var RelayCore = __webpack_require__(23);
	var RelayInMemoryRecordSource = __webpack_require__(8);
	var RelayMarkSweepStore = __webpack_require__(37);
	var RelayModernEnvironment = __webpack_require__(38);
	var RelayModernGraphQLTag = __webpack_require__(25);
	var RelayNetwork = __webpack_require__(41);
	var RelayObservable = __webpack_require__(13);
	var RelayQueryResponseCache = __webpack_require__(43);
	var RelayViewerHandler = __webpack_require__(31);

	var applyRelayModernOptimisticMutation = __webpack_require__(48);
	var commitLocalUpdate = __webpack_require__(49);
	var commitRelayModernMutation = __webpack_require__(50);
	var fetchRelayModernQuery = __webpack_require__(51);
	var isRelayModernEnvironment = __webpack_require__(17);
	var requestRelaySubscription = __webpack_require__(57);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayConcreteNode = __webpack_require__(7);

	var invariant = __webpack_require__(1);
	var stableJSONStringify = __webpack_require__(19);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var areEqual = __webpack_require__(20);
	var deepFreeze = __webpack_require__(14);
	var invariant = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayRecordState = __webpack_require__(9);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayInMemoryRecordSource = __webpack_require__(8);
	var RelayModernRecord = __webpack_require__(5);
	var RelayResponseNormalizer = __webpack_require__(47);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var generateRelayClientID = __webpack_require__(10);
	var getRelayHandleKey = __webpack_require__(16);
	var invariant = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function rangeAdd(config, operation) {
	  ...
	  if (!parentID) {
	     true ? warning(false, 'setRelayModernMutationConfigs: For mutation config RANGE_ADD ' + 'to work you must include a parentID') : void 0;
	    return;
	  }
	  var rootField = getRootField(operation);
	            ...
	            if (serverEdge) {
	              ...
	              switch (info.rangeBehavior) {
	                ...
	                case 'prepend':
	                  ...
	                  break;
	                default:
	                   true ? warning(false, 'setRelayModernMutationConfigs: RANGE_ADD range behavior ' + ('\'' + info.rangeBehavior + '\' will not work as expected in RelayModern, ') + "supported range behaviors are 'append', 'prepend', and " + "'ignore'") : void 0;
	                  break;
	              }
	            }
	          }
	...
	function rangeDelete(config, operation) {
	  ...
	  if (!parentID) {
	     true ? warning(false, 'setRelayModernMutationConfigs: For mutation config RANGE_DELETE ' + 'to work you must include a parentID') : void 0;
	    return;
	  }
	  var rootField = getRootField(operation);
	  if (rootField) {
	...
	function deleteNode(parentID, connectionKeys, pathToConnection, store, deleteIDs) {
	   true ? warning(connectionKeys, 'setRelayModernMutationConfigs: RANGE_DELETE must provide a ' + 'connectionKeys') : void 0;
	  var parent = store.get(parentID);
	  if (!parent) {
	    return;
	  }
	  if (pathToConnection.length >= 2) {
	    ...
	    if (connectionKeys && recordProxy) {
	      ...
	      try {
	       ...
	       true ? warning(false, 'setRelayModernMutationConfigs: RANGE_DELETE ' + 'pathToConnection is incorrect. Unable to find connection with ' + 'parentID: %s and path: %s', parentID, pathToConnection.toString()) : void 0;
	    }
	  } else {
	     true ? warning(false, 'setRelayModernMutationConfigs: RANGE_DELETE ' + 'pathToConnection must include at least parent and connection') : void 0;
	  }
	}
	  ...
	  fragment.argumentDefinitions.forEach(function (definition) {
	    ...
	    switch (definition.kind) {
	      case 'LocalArgument':
	        ...
	        break;
	      case 'RootArgument':
	        !rootVariables.hasOwnProperty(definition.name) ?  true ? invariant(false, 'RelayConcreteVariables: Expected a defined query variable for `$%s` ' + 'in fragment `%s`.', definition.name, fragment.name) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayModernFragmentSpecResolver = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayConcreteNode = __webpack_require__(7);
	var RelayRecordSourceMutator = __webpack_require__(29);
	var RelayStoreUtils = __webpack_require__(2);

	var cloneRelayHandleSourceField = __webpack_require__(32);
	var invariant = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	graphql.experimental = function (strings) {
	   true ?  true ? invariant(false, 'graphql.experimental: Unexpected invocation at runtime. Either the ' + 'Babel transform was not set up, or it failed to identify this call ' + 'site. Make sure it is being used verbatim as `graphql`.') : invariant(false) : void 0;
	};
	...
	function getFragment(taggedNode) {
	  ...
	  !(typeof fragment === 'object' && fragment !== null && fragment.kind === 'Fragment') ?  true ? invariant(false, 'RelayModernGraphQLTag: Expected a fragment, got `%s`.', JSON.stringify(fragment)) : invariant(false) : void 0;
	  return fragment;
	}

	function getOperation(taggedNode) {
	  var operation = getNode(taggedNode);
	  !(typeof operation === 'object' && operation !== null && operation.kind === 'Batch') ?  true ? invariant(false, 'RelayModernGraphQLTag: Expected an operation, got `%s`.', JSON.stringify(operation)) : invariant(false) : void 0;
	  return operation;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var removeFromArray = __webpack_require__(61);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var areEqual = __webpack_require__(20);
	var formatStorageKey = __webpack_require__(15);
	var getRelayHandleKey = __webpack_require__(16);
	var invariant = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var sprintf = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayDataLoader = __webpack_require__(24);
	var RelayModernRecord = __webpack_require__(5);
	var RelayProfiler = __webpack_require__(27);
	var RelayReader = __webpack_require__(28);
	var RelayReferenceMarker = __webpack_require__(46);

	var deepFreeze = __webpack_require__(14);
	var hasOverlappingIDs = __webpack_require__(52);
	var recycleNodesInto = __webpack_require__(56);
	var resolveImmediate = __webpack_require__(62);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCore = __webpack_require__(23);
	var RelayDataLoader = __webpack_require__(24);
	var RelayDefaultHandlerProvider = __webpack_require__(35);
	var RelayInMemoryRecordSource = __webpack_require__(8);
	var RelayPublishQueue = __webpack_require__(42);

	var normalizePayload = __webpack_require__(55);
	var normalizeRelayPayload = __webpack_require__(11);
	var warning = __webpack_require__(4);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var isScalarAndEqual = __webpack_require__(54);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayReader = __webpack_require__(28);
	var RelayRecordSourceMutator = __webpack_require__(29);
	var RelayRecordSourceProxy = __webpack_require__(45);
	var RelayRecordSourceSelectorProxy = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getCacheKey(queryID, variables) {
	  return stableJSONStringify({ queryID: queryID, variables: variables });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayModernRecord = __webpack_require__(5);
	var RelayRecordProxy = __webpack_require__(44);
	var RelayRecordSourceSelectorProxy = __webpack_require__(30);
	...
	var RelayResponseNormalizer = function () {
	  ...
	  RelayResponseNormalizer.prototype._traverseSelections = function _traverseSelections(selections, record, data) {
	    ...
	    selections.forEach(function (selection) {
	      if (selection.kind === SCALAR_FIELD || selection.kind === LINKED_FIELD) {
	        ...
	        var handleKey = getRelayHandleKey(selection.handle, selection.key, selection.name);
	  ...
	  RelayResponseNormalizer.prototype._normalizeField = function _normalizeField(selection, record, data) {
	    ...
	    if (fieldValue == null) {
	      ...
	      if (true) {
	         true ? warning(Object.prototype.hasOwnProperty.call(data, responseKey), 'RelayResponseNormalizer(): Payload did not contain a value ' + 'for field `%s: %s`. Check that you are parsing with the same ' + 'query that was used to fetch the payload.', responseKey, storageKey) : void 0;
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var isRelayModernEnvironment = __webpack_require__(17);
	var setRelayModernMutationConfigs = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayError = __webpack_require__(36);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function requestRelaySubscription(environment, config) {
	  ...
	  var _ref = configs ? setRelayModernMutationConfigs(configs, subscription, null /* optimisticUpdater */
