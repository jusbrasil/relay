...
var RelayNetworkLoggerTransaction = function () {
  ...
  RelayNetworkLoggerTransaction.prototype.commitLogs = function commitLogs(error, response, status) {
    !(this._hasCommittedLogs === false) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'The logs for transaction #' + this._id + ' have already been committed.') : invariant(false) : void 0;
