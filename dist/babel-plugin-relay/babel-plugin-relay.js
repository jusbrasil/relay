...
/***/ (function(module, exports, __webpack_require__) {
	...
	var compileGraphQLTag = __webpack_require__(16);
	var compileRelayQLTag = __webpack_require__(9);
	var getDocumentName = __webpack_require__(21);
	var getValidGraphQLTag = __webpack_require__(23);
	var getValidRelayQLTag = __webpack_require__(24);
	  ...
	  var visitor = {
	    TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
	      ...
	      if (quasi && tagName) {
	        ...
	        !_schema ?  true ? invariant(false, 'babel-plugin-relay: Missing schema option. ' + 'Check your .babelrc file or wherever you configure your Babel ' + 'plugins to ensure the "relay" plugin has a "schema" option.\n' + 'https://facebook.github.io/relay/docs/babel-plugin-relay.html#additional-options') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayTransformError = __webpack_require__(5);
	...
	var RelayQLNode = function () {
	  ...
	  RelayQLNode.prototype.getType = function getType() {
	     true ?  true ? invariant(false, 'Missing Implementation') : invariant(false) : void 0;
	  };
	...
	var RelayQLType = function () {
	  ...
	  RelayQLType.prototype.getConcreteTypes = function getConcreteTypes() {
	    ...
	    !this.isAbstract() ?  true ? invariant(false, 'Cannot get concrete types of a concrete type.') : invariant(false) : void 0;
	...
	var RelayQLFieldDefinition = function () {
	  ...
	  RelayQLFieldDefinition.prototype.getArgument = function getArgument(argName) {
	    ...
	    !schemaArg ?  true ? invariant(false, 'You tried to get an argument named `%s` on field `%s`, but no such ' + 'argument exists on that field.', argName, this.getName()) : invariant(false) : void 0;
	...
	var RelayQLArgumentType = function () {
	  ...
	  RelayQLArgumentType.prototype.ofType = function ofType() {
	    !(this.isList() || this.isNonNull()) ?  true ? invariant(false, 'Can only get type of list or non-null type.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createTransformError = __webpack_require__(20);
	var getClassicTransformer = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLTransformer = __webpack_require__(15);

	var getSchemaIntrospection = __webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLPrinter = __webpack_require__(14);
	...
	var RelayQLTransformer = function () {
	  ...
	  RelayQLTransformer.prototype.processTemplateLiteral = function processTemplateLiteral(node, documentName) {
	    ...
	    node.quasis.forEach(function (element, ii) {
	      ...
	      if (!element.tail) {
	        ...
	        if (/:\s*$/.test(chunk)) {
	          !_this.options.substituteVariables ?  true ? invariant(false, 'You supplied a GraphQL document named `%s` that uses template ' + 'substitution for an argument value, but variable substitution ' + 'has not been enabled.', documentName) : invariant(false) : void 0;
	          chunks.push('$' + name);
	  ...
	  RelayQLTransformer.prototype.processTemplateText = function processTemplateText(templateText, _ref) {
	    ...
	    !matches ?  true ? invariant(false, 'You supplied a GraphQL document named `%s` with invalid syntax. It ' + 'must start with `fragment`, `mutation`, `query`, or `subscription`.', documentName) : invariant(false) : void 0;
	    var type = matches[1];
	    ...
	    if (definition.kind === 'FragmentDefinition') {
	      ...
	      if (definition.operation === 'mutation') {
	        ...
	        return new RelayQLSubscription(context, definition);
	         ...
	         true ?  true ? invariant(false, 'Unsupported operation: %s', definition.operation) : invariant(false) : void 0;
	      }
	    } else {
	       true ?  true ? invariant(false, 'Unsupported definition kind: %s', definition.kind) : invariant(false) : void 0;
	    }
	  };

	  RelayQLTransformer.prototype.validateDocument = function validateDocument(document, documentName) {
	    !(document.definitions.length === 1) ?  true ? invariant(false, 'You supplied a GraphQL document named `%s` with %d definitions, but ' + 'it must have exactly one definition.', documentName, document.definitions.length) : invariant(false) : void 0;
	    var definition = document.definitions[0];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createClassicNode = __webpack_require__(17);
	var createCompatNode = __webpack_require__(18);
	var createModernNode = __webpack_require__(19);
	var getFragmentNameParts = __webpack_require__(12);
	...
	function createAST(t, state, path, graphqlDefinition) {
	  ...
	  var modernNode = createModernNode(t, graphqlDefinition, isHasteMode);
	  if (isCompatMode) {
...
/***/ (function(module, exports, __webpack_require__) {
	  ...
	  var visitors = {
	    ...
	    FragmentSpread: function FragmentSpread(node) {
	      ...
	      if (directives.length === 0) {
	        ...
	        !(directives.length === 1) ?  true ? invariant(false, 'BabelPluginRelay: Cannot use both `@arguments` and `@relay(mask: false)` on the ' + 'same fragment spread when in compat mode.') : invariant(false) : void 0;
	        switch (directive.name.value) {
	          ...
	          case 'relay':
	            ...
	            !(relayArguments.length === 1 && relayArguments[0].name.value === 'mask') ?  true ? invariant(false, 'BabelPluginRelay: Expected `@relay` directive to only have `mask` argument in ' + 'compat mode, but get %s', relayArguments[0].name.value) : invariant(false) : void 0;
	            substitutionName = fragmentName;
	      ...
	      !substitutionName ?  true ? invariant(false, 'BabelPluginRelay: Expected `substitutionName` to be non-null') : invariant(false) : void 0;
	...
	function getSchemaOption(state) {
	  ...
	  !schema ?  true ? invariant(false, 'babel-plugin-relay: Missing schema option. ' + 'Check your .babelrc file or wherever you configure your Babel ' + 'plugins to ensure the "relay" plugin has a "schema" option.\n' + 'https://facebook.github.io/relay/docs/babel-plugin-relay.html#additional-options') : invariant(false) : void 0;
	  return schema;
	}
	...
	function createSubstitutionsForFragmentSpreads(t, path, fragments) {
	  return Object.keys(fragments).map(function (varName) {
	    ...
	    if (!fragment.isMasked) {
	      !(path.scope.hasBinding(module) || path.scope.hasBinding(propName)) ?  true ? invariant(false, 'BabelPluginRelay: Please make sure module \'' + module + '\' is imported and not renamed or the\n        fragment \'' + fragment.name + '\' is defined and bound to local variable \'' + propName + '\'. ') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getSchemaIntrospection(schemaPath, basePath) {
	  try {
	    ...
	    var source = fs.readFileSync(fullSchemaPath, 'utf8');
	    if (source[0] === '{') {
