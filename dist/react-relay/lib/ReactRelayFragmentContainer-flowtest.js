...
module.exports = {
  ...
  checkWrongOptionalType: function checkWrongOptionalType() {
    ...
    return React.createElement(Bar, { optionalProp: 'wrongType', requiredProp: 'foo' });
  },
  checkNullOptionalType: function checkNullOptionalType() {
    ...
    return React.createElement(Bar, { optionalProp: null, requiredProp: 'foo' });
  },
  checkWrongDefaultPropType: function checkWrongDefaultPropType() {
    ...
    return React.createElement(Bar, { defaultProp: false, requiredProp: 'foo' });
  },
  checkAllPossibleProps: function checkAllPossibleProps() {
    // All is well
    return React.createElement(Bar, { defaultProp: 'bar', optionalProp: { foo: 42 }, requiredProp: 'foo' });
  },
