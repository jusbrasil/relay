...
function assertRelayContext(relay) {
  !isRelayContext(relay) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'ReactRelayRefetchContainer: Expected `context.relay` to be an object ' + 'conforming to the `RelayContext` interface, got `%s`.', relay) : invariant(false) : void 0;
  return relay;
}
