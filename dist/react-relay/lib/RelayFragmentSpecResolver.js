    ...
    forEachObject(selectors, function (selector, key) {
      ...
      if (selector == null) {
        ...
        if (resolver == null) {
          ...
          !(resolver instanceof SelectorListResolver) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayFragmentSpecResolver: Expected prop `%s` to always be an array.', key) : invariant(false) : void 0;
        ...
        if (resolver == null) {
          ...
          !(resolver instanceof SelectorResolver) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayFragmentSpecResolver: Expected prop `%s` to always be an object.', key) : invariant(false) : void 0;
