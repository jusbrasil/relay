...
var PendingGraphQLTransaction = function () {
  ...
  PendingGraphQLTransaction.prototype._getVariables = function _getVariables() {
    ...
    if (!input) {
      !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayGraphQLMutation: Required `input` variable is missing ' + '(supplied variables were: [%s]).', Object.keys(this._variables).join(', ')) : invariant(false) : void 0;
    }
