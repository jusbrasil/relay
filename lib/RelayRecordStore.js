...
var RelayRecordStore = (function () {
  ...
  RelayRecordStore.prototype.getLinkedRecordID = function getLinkedRecordID(dataID, storageKey) {
    ...
    !(typeof field === 'object' && field !== null && !Array.isArray(field) && (field.__dataID__ == null || typeof field.__dataID__ === 'string')) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayRecordStore.getLinkedRecordID(): Expected field `%s` for record ' + '`%s` to have a linked record.', storageKey, dataID) : invariant(false) : undefined;
