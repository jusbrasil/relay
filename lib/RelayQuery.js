...
var RelayQueryOperation = function (_RelayQueryNode2) {
  ...
  function RelayQueryOperation(concreteNode, route, variables) {
    ...
    !(_this6.constructor.name !== 'RelayQueryOperation') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryOperation: Abstract class cannot be instantiated.') : invariant(false) : void 0;
    return _this6;
  }
