...
var RelayQueryRoot = function (_RelayQueryNode) {
  ...
  RelayQueryRoot.build = function build(name, fieldName, value, children, metadata, type, routeName) {
    ...
    var root = new RelayQueryRoot(concreteRoot, RelayMetaRoute.get(routeName || '$RelayQuery'), {});
...
var RelayQueryOperation = function (_RelayQueryNode2) {
  ...
  function RelayQueryOperation(concreteNode, route, variables) {
    ...
    var _this4 = (0, _possibleConstructorReturn3['default'])(this, _RelayQueryNode2.call(this, concreteNode, route, variables));
...
var RelayQueryMutation = function (_RelayQueryOperation) {
  ...
  RelayQueryMutation.build = function build(name, responseType, callName, callValue, children, metadata, routeName) {
    ...
    var mutation = new RelayQueryMutation(concreteMutation, RelayMetaRoute.get(routeName || '$RelayQuery'), { input: callValue || '' });
...
var RelayQueryFragment = function (_RelayQueryNode3) {
  ...
  children, metadata, routeName) {
    ...
    var fragment = new RelayQueryFragment(concreteFragment, RelayMetaRoute.get(routeName || '$RelayQuery'), {}, {
  ...
  function RelayQueryFragment(concreteNode, route, variables, metadata) {
    ...
    var _this7 = (0, _possibleConstructorReturn3['default'])(this, _RelayQueryNode3.call(this, concreteNode, route, variables));
...
var RelayQueryField = function (_RelayQueryNode4) {
  ...
  RelayQueryField.build = function build(_ref) {
    ...
    var field = new RelayQueryField(concreteField, RelayMetaRoute.get(routeName || '$RelayQuery'), {});
  ...
  function RelayQueryField(concreteNode, route, variables) {
    ...
    var _this8 = (0, _possibleConstructorReturn3['default'])(this, _RelayQueryNode4.call(this, concreteNode, route, variables));
