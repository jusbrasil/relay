...
var restoreFragmentDataFromCache = _require.restoreFragmentDataFromCache;
var restoreQueriesDataFromCache = _require.restoreQueriesDataFromCache;
...
var RelayStoreData = function () {
  function RelayStoreData() {
    ...
    var rangeData = arguments.length <= 6 || arguments[6] === undefined ? new GraphQLStoreRangeUtils() : arguments[6];
