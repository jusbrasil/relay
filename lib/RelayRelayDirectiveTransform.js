...
function fragmentSpreadMetadata(_ref3) {
  ...
  !(deferrable === undefined || typeof deferrable === 'boolean') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "deferrable" argument to ' + '@relay to be a boolean literal if specified.') : invariant(false) : void 0;
  !!(deferrable === true && mask === false) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayRelayDirectiveTransform: Cannot unmask a deferrable fragment spread.') : invariant(false) : void 0;
