    ...
    selections.every(function (selection) {
      switch (selection.kind) {
        ...
        case LINKED_HANDLE:
          ...
          break;
        default:
          !(selection.kind === SCALAR_FIELD) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayAsyncLoader(): Unexpected ast kind `%s`.', selection.kind) : invariant(false) : void 0;
      }
      return !_this2._done;
    });
  };
