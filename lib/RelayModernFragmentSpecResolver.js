      ...
      if (selectors.hasOwnProperty(_key4)) {
        ...
        if (selector == null) {
          ...
          if (resolver == null) {
            ...
            !(resolver instanceof SelectorListResolver) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayModernFragmentSpecResolver: Expected prop `%s` to always be an array.', _key4) : invariant(false) : void 0;
          ...
          if (resolver == null) {
            ...
            !(resolver instanceof SelectorResolver) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayModernFragmentSpecResolver: Expected prop `%s` to always be an object.', _key4) : invariant(false) : void 0;
