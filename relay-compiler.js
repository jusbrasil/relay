...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLCompilerContext = __webpack_require__(7);
	var RelayCodeGenerator = __webpack_require__(29);
	var RelayFileWriter = __webpack_require__(58);
	var RelayIRTransforms = __webpack_require__(63);
	var RelayJSModuleParser = __webpack_require__(64);
	var RelayParser = __webpack_require__(19);

	var compileRelayArtifacts = __webpack_require__(35);
	var formatGeneratedModule = __webpack_require__(77);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ASTCache = __webpack_require__(23);
	var ASTConvert = __webpack_require__(39);
	var CodegenDirectory = __webpack_require__(24);
	var CodegenRunner = __webpack_require__(40);
	var CodegenWatcher = __webpack_require__(25);
	var DotGraphQLParser = __webpack_require__(41);
	var FilterDirectivesTransform = __webpack_require__(42);
	var FlattenTransform = __webpack_require__(44);
	var GraphQLCompilerContext = __webpack_require__(7);
	var GraphQLCompilerProfiler = __webpack_require__(8);
	var GraphQLConsoleReporter = __webpack_require__(45);
	var GraphQLIRPrinter = __webpack_require__(16);
	var GraphQLIRTransformer = __webpack_require__(10);
	var GraphQLIRVisitor = __webpack_require__(17);
	var GraphQLMultiReporter = __webpack_require__(46);
	var GraphQLParser = __webpack_require__(47);
	var GraphQLSchemaUtils = __webpack_require__(12);
	var GraphQLValidator = __webpack_require__(28);
	var GraphQLWatchmanClient = __webpack_require__(18);
	var InlineFragmentsTransform = __webpack_require__(48);
	var SkipClientFieldTransform = __webpack_require__(68);
	var SkipRedundantNodesTransform = __webpack_require__(69);
	var SkipUnreachableNodeTransform = __webpack_require__(70);
	var StripUnusedVariablesTransform = __webpack_require__(72);

	var filterContextForNode = __webpack_require__(76);
	var getIdentifierForArgumentValue = __webpack_require__(78);
	var getLiteralArgumentValues = __webpack_require__(79);
	var isEquivalentType = __webpack_require__(82);
	...
	var GraphQLCompilerContext = function () {
	  ...
	  GraphQLCompilerContext.prototype.replace = function replace(node) {
	    return this._update(this._documents.update(node.name, function (existing) {
	      !existing ?  true ? invariant(false, 'GraphQLCompilerContext: Expected to replace existing node %s, but' + 'one was not found in the context.', node.name) : invariant(false) : void 0;
	      return node;
	    }));
	  };
	  ...
	  GraphQLCompilerContext.prototype.add = function add(node) {
	    return this._update(this._documents.update(node.name, function (existing) {
	      !!existing ?  true ? invariant(false, 'GraphQLCompilerContext: Duplicate document named `%s`. GraphQL ' + 'fragments and roots must have unique names.', node.name) : invariant(false) : void 0;
	      return node;
	    }));
	  };
	  ...
	  GraphQLCompilerContext.prototype.getRoot = function getRoot(name) {
	    var node = this._get(name);
	    !(node.kind === 'Root') ?  true ? invariant(false, 'GraphQLCompilerContext: Expected `%s` to be a root, got `%s`.', name, node.kind) : invariant(false) : void 0;
	    return node;
	  };
	  ...
	  GraphQLCompilerContext.prototype._get = function _get(name) {
	    ...
	    !document ?  true ? invariant(false, 'GraphQLCompilerContext: Unknown document `%s`.', name) : invariant(false) : void 0;
	    return document;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function end(traceIdx) {
	  ...
	  !(trace.ph === 'B') ?  true ? invariant(false, 'Begin trace phase') : invariant(false) : void 0;
	  !(stack.pop() === trace) ?  true ? invariant(false, 'GraphQLCompilerProfiler: The profile trace %s ended before nested traces. ' + 'If it is async, try using Profile.waitFor or Profile.profileWait.', trace.name) : invariant(false) : void 0;
	...
	var Transformer = function () {
	  ...
	  Transformer.prototype._traverse = function _traverse(prevNode) {
	    ...
	    switch (prevNode.kind) {
	      ...
	      case 'Request':
	        ...
	        break;
	      default:
	         true ?  true ? invariant(false, 'GraphQLIRTransformer: Unknown kind `%s`.', prevNode.kind) : invariant(false) : void 0;
	    }
	    return nextNode;
	  };
	  ...
	  Transformer.prototype._traverseChildren = function _traverseChildren(prevNode, pluralKeys, singularKeys) {
	    ...
	    pluralKeys && pluralKeys.forEach(function (key) {
	      ...
	      !Array.isArray(prevItems) ?  true ? invariant(false, 'GraphQLIRTransformer: Expected data for `%s` to be an array, got `%s`.', key, prevItems) : invariant(false) : void 0;
	  ...
	  Transformer.prototype._getState = function _getState() {
	    !this._states.length ?  true ? invariant(false, 'GraphQLIRTransformer: Expected a current state to be set but found none. ' + 'This is usually the result of mismatched number of pushState()/popState() ' + 'calls.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function hasID(schema, type) {
	  var unmodifiedType = getRawType(type);
	  !(unmodifiedType instanceof GraphQLObjectType || unmodifiedType instanceof GraphQLInterfaceType) ?  true ? invariant(false, 'GraphQLSchemaUtils.hasID(): Expected a concrete type or interface, ' + 'got type `%s`.', type) : invariant(false) : void 0;
	...
	function assertTypeWithFields(type) {
	  !(type instanceof GraphQLObjectType || type instanceof GraphQLInterfaceType) ?  true ? invariant(false, 'GraphQLSchemaUtils: Expected type `%s` to be an object or interface type.', type) : invariant(false) : void 0;
	  return type;
	}
	...
	function getTypeFromAST(schema, ast) {
	  ...
	  !isType(type) ?  true ? invariant(false, 'GraphQLSchemaUtils: Unknown type `%s`.', print(ast)) : invariant(false) : void 0;
	  return type;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function print(node) {
	  if (node.kind === 'Fragment') {
	    ...
	    return node.operation + ' ' + node.name + printArgumentDefinitions(node.argumentDefinitions) + printDirectives(node.directives) + printSelections(node, '') + '\n';
	     ...
	     true ?  true ? invariant(false, 'GraphQLIRPrinter: Unsupported IR node `%s`.', node.kind) : invariant(false) : void 0;
	  }
	}
	...
	function printSelection(selection, indent, parentCondition) {
	  ...
	  if (selection.kind === 'LinkedField') {
	    ...
	    // For Flow
	    !(value != null) ?  true ? invariant(false, 'GraphQLIRPrinter: Expected a variable for condition, got a literal `null`.') : invariant(false) : void 0;
	    ...
	    str = subSelections.join('\n' + INDENT);
	     ...
	     true ?  true ? invariant(false, 'GraphQLIRPrinter: Unknown selection kind `%s`.', selection.kind) : invariant(false) : void 0;
	  }
	  return str;
	}
	...
	function printValue(value, type) {
	  ...
	  if (value.kind === 'Variable') {
	    ...
	    !(type instanceof GraphQLInputObjectType) ?  true ? invariant(false, 'GraphQLIRPrinter: Need an InputObject type to print objects.') : invariant(false) : void 0;
	    ...
	    !(type instanceof GraphQLList) ?  true ? invariant(false, 'GraphQLIRPrinter: Need a type in order to print arrays.') : invariant(false) : void 0;
	...
	function printLiteral(value, type) {
	  ...
	  if (type instanceof GraphQLEnumType) {
	    !(typeof value === 'string') ?  true ? invariant(false, 'GraphQLIRPrinter: Expected value of type %s to be a string, got `%s`.', type.name, value) : invariant(false) : void 0;
	    return value;
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var watchman = __webpack_require__(94);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getName(ast) {
	  ...
	  !(typeof name === 'string') ?  true ? invariant(false, 'RelayParser: Expected ast node `%s` to have a name.', ast) : invariant(false) : void 0;
	  return name;
	}
	...
	var CodegenDirectory = function () {
	  function CodegenDirectory(dir) {
	    ...
	    if (fs.existsSync(dir)) {
	      !fs.statSync(dir).isDirectory() ?  true ? invariant(false, 'Expected `%s` to be a directory.', dir) : invariant(false) : void 0;
	  ...
	  CodegenDirectory.prototype.writeFile = function writeFile(filename, content) {
	    ...
	    Profiler.run('CodegenDirectory.writeFile', function () {
	      ...
	      var filePath = path.join(_this._dir, filename);
	      if (fs.existsSync(filePath)) {
	  ...
	  CodegenDirectory.prototype.deleteExtraFiles = function deleteExtraFiles() {
	    ...
	    Profiler.run('CodegenDirectory.deleteExtraFiles', function () {
	      fs.readdirSync(_this2._dir).forEach(function (actualFile) {
	        if (!_this2._files.has(actualFile) && !/^\./.test(actualFile)) {
	          if (!_this2.onlyValidate) {
	            try {
	              fs.unlinkSync(path.join(_this2._dir, actualFile));
	            } catch (e) {
	  ...
	  CodegenDirectory.prototype._addGenerated = function _addGenerated(filename) {
	    !!this._files.has(filename) ?  true ? invariant(false, 'CodegenDirectory: Tried to generate `%s` twice in `%s`.', filename, this._dir) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let queryFiles = (() => {
	  var _ref3 = (0, _asyncToGenerator3.default)(function* (baseDir, expression, filter) {
	    return yield Profiler.waitFor('Watchman:query', (0, _asyncToGenerator3.default)(function* () {
	      var client = new GraphQLWatchmanClient();
	...
	let watch = (() => {
	  var _ref7 = (0, _asyncToGenerator3.default)(function* (baseDir, expression, callback) {
	    return yield Profiler.waitFor('Watchman:subscribe', (0, _asyncToGenerator3.default)(function* () {
	      var client = new GraphQLWatchmanClient();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var stableCopy = __webpack_require__(85);
	...
	function generate(node) {
	  !(['Batch', 'Fragment'].indexOf(node.kind) >= 0) ?  true ? invariant(false, 'RelayCodeGenerator: Unknown AST kind `%s`. Source: %s.', node.kind, getErrorMessage(node)) : invariant(false) : void 0;
	...
	var RelayCodeGenVisitor = {
	  leave: {
	    Batch: function Batch(node) {
	      !(node.requests.length !== 0) ?  true ? invariant(false, 'Batch must contain Requests.') : invariant(false) : void 0;
	    ...
	    Condition: function Condition(node, key, parent, ancestors) {
	      !(node.condition.kind === 'Variable') ?  true ? invariant(false, 'RelayCodeGenerator: Expected static `Condition` node to be ' + 'pruned or inlined. Source: %s.', getErrorMessage(ancestors[0])) : invariant(false) : void 0;
	      return {
	        kind: 'Condition',
	    ...
	    Argument: function Argument(node, key, parent, ancestors) {
	      !(['Variable', 'Literal'].indexOf(node.value.kind) >= 0) ?  true ? invariant(false, 'RelayCodeGenerator: Complex argument values (Lists or ' + 'InputObjects with nested variables) are not supported, argument ' + '`%s` had value `%s`. Source: %s.', node.name, JSON.stringify(node.value, null, 2), getErrorMessage(ancestors[0])) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function intersectionTypeAnnotation(types) {
	  !(types.length > 0) ?  true ? invariant(false, 'RelayFlowBabelFactories: cannot create an intersection of 0 types') : invariant(false) : void 0;
	...
	function unionTypeAnnotation(types) {
	  !(types.length > 0) ?  true ? invariant(false, 'RelayFlowBabelFactories: cannot create a union of 0 types') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragment(fragment, state) {
	  ...
	  state.hoistedArgDefs.forEach(function (hoistedArgDef, argName) {
	    ...
	    if (existingArgDef) {
	      !areSameArgumentDefinitions(existingArgDef, hoistedArgDef.argDef) ?  true ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because ' + 'argument `%s` has been declared in `%s` and they are not the same.', hoistedArgDef.source, argName, fragment.name) : invariant(false) : void 0;
	      return;
	    }
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  ...
	  !(fragmentSpread.args.length === 0) ?  true ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` with ' + 'arguments. Use the `ApplyFragmentArgumentTransform` before flattening', fragmentSpread.name) : invariant(false) : void 0;
	  ...
	  }) ?  true ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because it has local ' + 'argument definition.', fragmentSpread.name) : invariant(false) : void 0;
	  ...
	  try {
	    for (var _iterator = fragment.argumentDefinitions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      if (hoistedArgDef) {
	        !areSameArgumentDefinitions(_argDef, hoistedArgDef.argDef) ?  true ? invariant(false, 'RelayMaskTransform: Cannot unmask fragment spread `%s` because ' + 'argument `%s` has been declared in `%s` and they are not the same.', hoistedArgDef.source, _argDef.name, fragmentSpread.name) : invariant(false) : void 0;
	        continue;
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function fragmentMetadata(_ref2) {
	  ...
	  !(plural === undefined || typeof plural === 'boolean') ?  true ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "plural" argument to @relay ' + 'to be a boolean literal if specified.') : invariant(false) : void 0;
	...
	function fragmentSpreadMetadata(_ref3) {
	  ...
	  !(mask === undefined || typeof mask === 'boolean') ?  true ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "mask" argument to @relay ' + 'to be a boolean literal if specified.') : invariant(false) : void 0;
	  !(deferrable === undefined || typeof deferrable === 'boolean') ?  true ? invariant(false, 'RelayRelayDirectiveTransform: Expected the "deferrable" argument to ' + '@relay to be a boolean literal if specified.') : invariant(false) : void 0;
	  !!(deferrable === true && mask === false) ?  true ? invariant(false, 'RelayRelayDirectiveTransform: Cannot unmask a deferrable fragment spread.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var requestsForOperation = __webpack_require__(84);
	...
	function compileRelayArtifacts(context, transforms, reporter) {
	  return Profiler.run('GraphQLCompiler.compile', function () {
	    ...
	    return fragmentContext.documents().map(function (node) {
	      return RelayCodeGenerator.generate(node.kind === 'Fragment' ? node : {
	        kind: 'Batch',
	        ...
	        requests: requestsForOperation(printContext, codeGenContext, node.name)
	      });
	    });
	  });
	}
	...
	function getIdentifierForSelection(node) {
	  if (node.kind === 'LinkedField' || node.kind === 'ScalarField') {
	    ...
	    return 'C:' + (node.condition.kind === 'Variable' ? '$' + node.condition.variableName : String(node.condition.value)) + String(node.passingValue);
	     ...
	     true ?  true ? invariant(false, 'getIdentifierForSelection: Unexpected kind `%s`.', node.kind) : invariant(false) : void 0;
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CodegenRunner = function () {
	  ...
	  CodegenRunner.prototype.getDirtyWriters = function getDirtyWriters(filePaths) {
	    ...
	    return Profiler.asyncContext('CodegenRunner:getDirtyWriters', (0, _asyncToGenerator3.default)(function* () {
	      ...
	      yield Promise.all(Object.keys(_this3.parserConfigs).map(function (parserConfigName) {
	        return Profiler.waitFor('Watchman:query', (0, _asyncToGenerator3.default)(function* () {
	          var client = new GraphQLWatchmanClient();
	  ...
	  CodegenRunner.prototype.write = function write(writerName) {
	    ...
	    return Profiler.asyncContext('CodegenRunner.write', (0, _asyncToGenerator3.default)(function* () {
	      try {
	        ...
	        var _schema = Profiler.run('getSchema', function () {
	          ...
	          for (var _iterator2 = outputDirectories.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            try {
	              for (var _iterator3 = all[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                ...
	                !_isGeneratedFile(_filePath2) ?  true ? invariant(false, 'CodegenRunner: %s returned false for isGeneratedFile, ' + 'but was in generated directory', _filePath2) : invariant(false) : void 0;
	              }
	            } catch (err) {
	    ...
	    var _ref8 = (0, _asyncToGenerator3.default)(function* (parserName) {
	      ...
	      yield CodegenWatcher.watchCompile(parserConfig.baseDir, parserConfig.watchmanExpression, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter, (() => {
	        var _ref9 = (0, _asyncToGenerator3.default)(function* (files) {
	          !_this6.parsers[parserName] ?  true ? invariant(false, 'Trying to watch an uncompiled parser config: %s', parserName) : invariant(false) : void 0;
	          if (firstChange) {
	            firstChange = false;
	            return;
	          }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompilerCache = __webpack_require__(51);

	var babylon = __webpack_require__(91);
	var getModuleName = __webpack_require__(80);
	var graphql = __webpack_require__(3);
	var path = __webpack_require__(9);
	var util = __webpack_require__(38);
	...
	var cache = new RelayCompilerCache('FindGraphQLTags', 'v1');
	...
	function memoizedFind(text, baseDir, file, options) {
	  ...
	  return cache.getOrCompute(file.hash + (options.validateNames ? '1' : '0'), function () {
	    var absPath = path.join(baseDir, file.relPath);
	...
	function validateTemplate(template, moduleName, keyName, filePath, loc) {
	  var ast = graphql.parse(new graphql.Source(template, filePath, loc));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var areEqual = __webpack_require__(73);
	...
	function flattenSelections(node, state) {
	  ...
	  !type ?  true ? invariant(false, 'FlattenTransform: Expected parent type.') : invariant(false) : void 0;
	...
	function flattenSelectionsInto(flattenedSelections, node, state, type) {
	  ...
	  node.selections.forEach(function (selection) {
	    ...
	    if (flattenedSelection.kind === 'InlineFragment') {
	      !(selection.kind === 'InlineFragment') ?  true ? invariant(false, 'FlattenTransform: Expected a ScalarField, got a %s', selection.kind) : invariant(false) : void 0;
	      ...
	      !(selection.kind === 'Condition') ?  true ? invariant(false, 'FlattenTransform: Expected a Condition, got a %s', selection.kind) : invariant(false) : void 0;
	      flattenedSelections.set(nodeIdentifier, (0, _extends3['default'])({}, flattenedSelection, {
	      ...
	      !(selection.kind === 'LinkedField') ?  true ? invariant(false, 'FlattenTransform: Expected a LinkedField, got a %s', selection.kind) : invariant(false) : void 0;
	      ...
	      !(selection.kind === 'ScalarField') ?  true ? invariant(false, 'FlattenTransform: Expected a ScalarField, got a %s', selection.kind) : invariant(false) : void 0;
	      // Note: arguments are intentionally reversed to avoid rebuilds
	      assertUniqueArgsForAlias(selection, flattenedSelection);
	      flattenedSelections.set(nodeIdentifier, (0, _extends3['default'])({
	        kind: 'ScalarField'
	       ...
	       true ?  true ? invariant(false, 'FlattenTransform: Unknown kind `%s`.', flattenedSelection.kind) : invariant(false) : void 0;
	    }
	  });
	  return hasFlattened;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chalk = __webpack_require__(92);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLParser = function () {
	  ...
	  GraphQLParser.transform = function transform(schema, definition) {
	    ...
	    return Profiler.run('GraphQLParser.transform', function () {
	  ...
	  GraphQLParser.prototype._recordAndVerifyVariableReference = function _recordAndVerifyVariableReference(name, usedAsType) {
	    ...
	    if (!previousType) {
	      ...
	      !(isTypeSubTypeOf(this._schema, usedAsType, previousType) || isTypeSubTypeOf(this._schema, previousType, usedAsType)) ?  true ? invariant(false, 'GraphQLParser: Variable `$%s` was used in locations expecting ' + 'the conflicting types `%s` and `%s`. Source: %s.', name, previousType, usedAsType, this._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype.transform = function transform() {
	    switch (this._definition.kind) {
	      ...
	      default:
	         true ?  true ? invariant(false, 'GraphQLParser: Unknown AST kind `%s`. Source: %s.', this._definition.kind, this._getErrorContext()) : invariant(false) : void 0;
	    }
	  };
	  ...
	  GraphQLParser.prototype._transformFragment = function _transformFragment(fragment) {
	    ...
	    var _loop = function _loop(_name) {
	      if (_this3._referencedVariableTypesByName.hasOwnProperty(_name)) {
	        ...
	        if (localArgument) {
	          !(variableType == null || isTypeSubTypeOf(_this3._schema, localArgument.type, variableType)) ?  true ? invariant(false, 'GraphQLParser: Variable `$%s` was defined as type `%s`, but used ' + 'in a location that expects type `%s`. Source: %s.', _name, localArgument.type, variableType, _this3._getErrorContext()) : invariant(false) : void 0;
	        } else {
	  ...
	  GraphQLParser.prototype._buildArgumentDefinitions = function _buildArgumentDefinitions(fragment) {
	    ...
	    !(variableDirectives.length === 1) ?  true ? invariant(false, 'GraphQLParser: Directive %s may be defined at most once on fragment ' + '`%s`. Source: %s.', ARGUMENT_DEFINITIONS, getName(fragment), this._getErrorContext()) : invariant(false) : void 0;
	    ...
	    !args.length ?  true ? invariant(false, 'GraphQLParser: Directive %s requires arguments: remove the directive ' + 'to skip defining local variables for this fragment `%s`. Source: %s.', ARGUMENT_DEFINITIONS, getName(fragment), this._getErrorContext()) : invariant(false) : void 0;
	    return args.map(function (arg) {
	      var argName = getName(arg);
	      var argValue = _this4._transformValue(arg.value);
	      !(argValue.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed}`, got `%s`. Source: %s.', argValue, _this4._getErrorContext()) : invariant(false) : void 0;
	      var value = argValue.value;
	      !(!Array.isArray(value) && typeof value === 'object' && value !== null && typeof value.type === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got `%s`. Source: %s.', argName, argValue, _this4._getErrorContext()) : invariant(false) : void 0;
	      ...
	      !(unknownKeys.length === 0) ?  true ? invariant(false, 'GraphQLParser: Expected definition for variable `%s` to be an ' + 'object with the following shape: `{type: string, defaultValue?: ' + 'mixed, nonNull?: boolean, list?: boolean}`, got unknown key(s) ' + '`%s`. Source: %s.', argName, unknownKeys.join('`, `'), _this4._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformOperation = function _transformOperation(definition) {
	    ...
	    switch (definition.operation) {
	      ...
	      case 'subscription':
	        ...
	        break;
	      default:
	         true ?  true ? invariant(false, 'GraphQLParser: Unknown AST kind `%s`. Source: %s.', definition.operation, this._getErrorContext()) : invariant(false) : void 0;
	    }
	    !definition.selectionSet ?  true ? invariant(false, 'GraphQLParser: Expected %s `%s` to have selections. Source: %s.', operation, name, this._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArgumentDefinitions = function _transformArgumentDefinitions(argumentDefinitions) {
	    ...
	    return argumentDefinitions.map(function (def) {
	      ...
	      if (_this5._referencedVariableTypesByName.hasOwnProperty(name)) {
	        ...
	        !(variableType == null || isTypeSubTypeOf(_this5._schema, type, variableType)) ?  true ? invariant(false, 'GraphQLParser: Variable `$%s` was defined as type `%s`, but used ' + 'in a location that expects type `%s`. Source: %s.', name, type, variableType, _this5._getErrorContext()) : invariant(false) : void 0;
	      }
	      !(defaultLiteral === null || defaultLiteral.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected null or Literal default value, got: `%s`. ' + 'Source: %s.', defaultLiteral && defaultLiteral.kind, _this5._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'LocalArgumentDefinition',
	        metadata: null,
	        name: name,
	    ...
	    return selectionSet.selections.map(function (selection) {
	      ...
	      if (selection.kind === 'Field') {
	        ...
	        node = _this6._transformInlineFragment(selection, parentType);
	         ...
	         true ?  true ? invariant(false, 'GraphQLParser: Unexpected AST kind `%s`. Source: %s.', selection.kind, _this6._getErrorContext()) : invariant(false) : void 0;
	      }
	      ...
	      !(conditionalNodes.length === 1) ?  true ? invariant(false, 'GraphQLParser: Expected exactly one conditional node, got `%s`. ' + 'Source: %s.', conditionalNodes.length, _this6._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformFragmentSpread = function _transformFragmentSpread(fragment, parentType) {
	    ...
	    !(argumentDirectives.length <= 1) ?  true ? invariant(false, 'GraphQLParser: Directive %s may be used at most once in fragment ' + 'spread `...%s`. Source: %s.', ARGUMENTS, fragmentName, this._getErrorContext()) : invariant(false) : void 0;
	    var args = void 0;
	    if (argumentDirectives.length) {
	      args = (argumentDirectives[0].arguments || []).map(function (arg) {
	        var argValue = arg.value;
	        !(argValue.kind === 'Variable') ?  true ? invariant(false, 'GraphQLParser: All @arguments() args must be variables, got %s. ' + 'Source: %s.', argValue.kind, _this7._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformField = function _transformField(field, parentType) {
	    ...
	    !fieldDef ?  true ? invariant(false, 'GraphQLParser: Unknown field `%s` on type `%s`. Source: %s.', name, parentType, this._getErrorContext()) : invariant(false) : void 0;
	    ...
	    if (isLeafType(getNamedType(type))) {
	      !(!field.selectionSet || !field.selectionSet.selections || !field.selectionSet.selections.length) ?  true ? invariant(false, 'GraphQLParser: Expected no selections for scalar field `%s` on type ' + '`%s`. Source: %s.', name, this._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'ScalarField',
	        alias: alias,
	        args: args,
	      ...
	      !(selections && selections.length) ?  true ? invariant(false, 'GraphQLParser: Expected at least one selection for non-scalar field ' + '`%s` on type `%s`. Source: %s.', name, type, this._getErrorContext()) : invariant(false) : void 0;
	      return {
	        kind: 'LinkedField',
	        alias: alias,
	        args: args,
	  ...
	  GraphQLParser.prototype._transformHandle = function _transformHandle(fieldName, fieldArgs, clientFieldDirectives) {
	    ...
	    clientFieldDirectives.forEach(function (clientFieldDirective) {
	      ...
	      if (handleArgument) {
	        ...
	        !(maybeHandle.kind === 'Literal' && typeof maybeHandle.value === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected the %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_HANDLE, CLIENT_FIELD, maybeHandle, fieldName, _this8._getErrorContext()) : invariant(false) : void 0;
	        ...
	        if (keyArgument) {
	          ...
	          !(maybeKey.kind === 'Literal' && typeof maybeKey.value === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be a literal ' + 'string, got `%s` on field `%s`. Source: %s.', CLIENT_FIELD_KEY, CLIENT_FIELD, maybeKey, fieldName, _this8._getErrorContext()) : invariant(false) : void 0;
	          key = maybeKey.value;
	        }
	        ...
	        if (filtersArgument) {
	          ...
	          })) ?  true ? invariant(false, 'GraphQLParser: Expected %s argument to @%s to be an array of ' + 'argument names on field `%s`, but get %s. Source: %s.', CLIENT_FIELD_FILTERS, CLIENT_FIELD, fieldName, maybeFilters, _this8._getErrorContext()) : invariant(false) : void 0;
	          // $FlowFixMe
	  ...
	  GraphQLParser.prototype._transformDirectives = function _transformDirectives(directives) {
	    ...
	    return directives.map(function (directive) {
	      ...
	      !directiveDef ?  true ? invariant(false, 'GraphQLParser: Unknown directive `@%s`. Source: %s.', name, _this9._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._transformArguments = function _transformArguments(args, argumentDefinitions) {
	    ...
	    return args.map(function (arg) {
	      ...
	      !argDef ?  true ? invariant(false, 'GraphQLParser: Unknown argument `%s`. Source: %s.', argName, _this10._getErrorContext()) : invariant(false) : void 0;
	  ...
	  GraphQLParser.prototype._splitConditions = function _splitConditions(mixedDirectives) {
	    ...
	    mixedDirectives.forEach(function (directive) {
	      if (directive.name === INCLUDE || directive.name === SKIP) {
	        ...
	        !(arg && arg.name === IF) ?  true ? invariant(false, 'GraphQLParser: Expected an `if` argument to @%s. Source: %s.', directive.name, _this11._getErrorContext()) : invariant(false) : void 0;
	        !(arg.value.kind === 'Variable' || arg.value.kind === 'Literal') ?  true ? invariant(false, 'GraphQLParser: Expected the `if` argument to @%s to be a variable. ' + 'Source: %s.', directive.name, _this11._getErrorContext()) : invariant(false) : void 0;
	        conditions.push({
	          kind: 'Condition',
	          condition: arg.value,
	          metadata: null,
	    ...
	    switch (ast.kind) {
	      ...
	      case 'ListValue':
	        ...
	        if (type) {
	          ...
	          // if `type` is a List.
	          !(listType instanceof GraphQLList) ?  true ? invariant(false, 'GraphQLParser: Expected a value matching type `%s`, but ' + 'got a list value. Source: %s.', type, this._getErrorContext()) : invariant(false) : void 0;
	      ...
	      case 'ObjectValue':
	        ...
	        ast.fields.forEach(function (field) {
	          ...
	          if (type) {
	            ...
	            !(objectType instanceof GraphQLInputObjectType) ?  true ? invariant(false, 'GraphQLParser: Expected a value matching type `%s`, but ' + 'got an object value. Source: %s.', type, _this12._getErrorContext()) : invariant(false) : void 0;
	            var fieldConfig = objectType.getFields()[fieldName];
	            !fieldConfig ?  true ? invariant(false, 'GraphQLParser: Unknown field `%s` on type `%s`. Source: %s.', fieldName, type, _this12._getErrorContext()) : invariant(false) : void 0;
	      ...
	      default:
	         true ?  true ? invariant(false, 'GraphQLParser: Unknown ast kind: %s. Source: %s.', ast.kind, this._getErrorContext()) : invariant(false) : void 0;
	    }
	  };
	...
	function assertScalarFieldType(type) {
	  !isScalarFieldType(type) ?  true ? invariant(false, 'Expected %s to be a Scalar Field type.', type) : invariant(false) : void 0;
	  return type;
	}
	...
	function getName(ast) {
	  var name = ast.name ? ast.name.value : null;
	  !(typeof name === 'string') ?  true ? invariant(false, 'GraphQLParser: Expected ast node `%s` to have a name.', ast) : invariant(false) : void 0;
	  return name;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitFragmentSpread(fragmentSpread, state) {
	  !(fragmentSpread.args.length === 0) ?  true ? invariant(false, 'InlineFragmentsTransform: Cannot flatten fragment spread `%s` with ' + 'arguments. Use the `ApplyFragmentArgumentTransform` before flattening', fragmentSpread.name) : invariant(false) : void 0;
	  var fragment = this.getContext().getFragment(fragmentSpread.name);
	  var result = {
	    kind: 'InlineFragment',
	    directives: fragmentSpread.directives,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var babelGenerator = __webpack_require__(87)['default'];
	var Printer = __webpack_require__(88);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompilerScope = __webpack_require__(52);

	var invariant = __webpack_require__(1);
	var murmurHash = __webpack_require__(83);
	...
	function transformCondition(context, fragments, scope, node) {
	  ...
	  !(condition.kind === 'Literal' || condition.kind === 'Variable') ?  true ? invariant(false, 'RelayApplyFragmentArgumentTransform: A non-scalar value was applied to ' + 'an @include or @skip directive, the `if` argument value must be a ' + 'variable or a Boolean, got `%s`.', condition) : invariant(false) : void 0;
	...
	function transformValue(scope, value) {
	  if (value.kind === 'Variable') {
	    ...
	    !(scopeValue != null) ?  true ? invariant(false, 'RelayApplyFragmentArgumentTransform: variable `%s` is not in scope.', value.variableName) : invariant(false) : void 0;
	    return scopeValue;
	  } else if (value.kind === 'ListValue') {
	...
	function transformFragment(context, fragments, parentScope, fragment, args) {
	  ...
	  !(!fragments.has(fragmentName) || fragments.get(fragmentName) !== undefined) ?  true ? invariant(false, 'RelayApplyFragmentArgumentTransform: Found a circular reference from ' + 'fragment `%s`.', fragment.name) : invariant(false) : void 0;
	...
	function hashArguments(args, scope) {
	  ...
	  var printedArgs = JSON.stringify(sortedArgs.map(function (arg) {
	    ...
	    if (arg.value.kind === 'Variable') {
	      ...
	      !(value != null) ?  true ? invariant(false, 'RelayApplyFragmentArgumentTransform: variable `%s` is not in scope.', arg.value.variableName) : invariant(false) : void 0;
	    } else {
	      value = arg.value;
	    }
	    return {
	...
	var RelayCompilerCache = function () {
	  ...
	  RelayCompilerCache.prototype.getOrCompute = function getOrCompute(key, compute) {
	    ...
	    return Profiler.run('RelayCompilerCache.getOrCompute', function () {
	      var cacheFile = path.join(_this._dir, key);
	...
	function getFragmentScope(definitions, args, parentScope) {
	  ...
	  definitions.forEach(function (definition) {
	    if (definition.kind === 'RootArgumentDefinition') {
	      !!argMap.hasOwnProperty(definition.name) ?  true ? invariant(false, 'RelayCompilerScope: Unexpected argument for global variable `%s`. ' + '@arguments may only be provided for variables defined in the ' + "fragment's @argumentDefinitions list.", definition.name) : invariant(false) : void 0;
	      ...
	      if (arg == null || arg.kind === 'Literal' && arg.value == null) {
	        ...
	        // value.
	        !(definition.defaultValue != null || !(definition.type instanceof GraphQLNonNull)) ?  true ? invariant(false, 'RelayCompilerScope: No value found for required argument ' + '`$%s: %s`.', definition.name, definition.type.toString()) : invariant(false) : void 0;
	        fragmentScope[definition.name] = {
	          kind: 'Literal',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitLinkedField(field, options) {
	  ...
	  !(typeof key === 'string') ?  true ? invariant(false, 'RelayConnectionTransform: Expected the %s argument to @%s to ' + 'be a string literal for field %s', KEY, CONNECTION, field.name) : invariant(false) : void 0;
	  var postfix = '' + (field.alias || field.name);
	  !key.endsWith('_' + postfix) ?  true ? invariant(false, 'RelayConnectionTransform: Expected the %s argument to @%s to ' + 'be of form <SomeName>_%s, but get %s. For detailed explanation, check out the dex page ' + 'https://facebook.github.io/relay/docs/pagination-container.html#connection-directive', KEY, CONNECTION, postfix, key) : invariant(false) : void 0;
	...
	function generateConnectionFragment(context, type, direction) {
	  ...
	  !(fragmentAST && fragmentAST.kind === 'FragmentDefinition') ?  true ? invariant(false, 'RelayConnectionTransform: Expected a fragment definition AST.') : invariant(false) : void 0;
	  var fragment = RelayParser.transform(context.clientSchema, fragmentAST);
	  !(fragment && fragment.kind === 'Fragment') ?  true ? invariant(false, 'RelayConnectionTransform: Expected a connection fragment.') : invariant(false) : void 0;
	  return {
	    directives: [],
	    kind: 'InlineFragment',
	    metadata: null,
	...
	function validateConnectionSelection(definitionName, field) {
	  ...
	  !(findArg(field, FIRST) || findArg(field, LAST)) ?  true ? invariant(false, 'RelayConnectionTransform: Expected field `%s: %s` to have a %s or %s ' + 'argument in document `%s`.', field.name, field.type, FIRST, LAST, definitionName) : invariant(false) : void 0;
	  !field.selections.some(function (selection) {
	    return selection.kind === 'LinkedField' && selection.name === EDGES;
	  }) ?  true ? invariant(false, 'RelayConnectionTransform: Expected field `%s: %s` to have a %s ' + 'selection in document `%s`.', field.name, field.type, EDGES, definitionName) : invariant(false) : void 0;
	}
	...
	function validateConnectionType(definitionName, type) {
	  ...
	  !edges ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s field in ' + 'document `%s`.', type, EDGES, definitionName) : invariant(false) : void 0;

	  var edgesType = SchemaUtils.getNullableType(edges.type);
	  !(edgesType instanceof GraphQLList) ?  true ? invariant(false, 'RelayConnectionTransform: Expected `%s` field on type `%s` to be a ' + 'list type in document `%s`.', EDGES, type, definitionName) : invariant(false) : void 0;
	  var edgeType = SchemaUtils.getNullableType(edgesType.ofType);
	  !(edgeType instanceof GraphQLObjectType) ?  true ? invariant(false, 'RelayConnectionTransform: Expected %s field on type `%s` to be a list ' + 'of objects in document `%s`.', EDGES, type, definitionName) : invariant(false) : void 0;

	  var node = edgeType.getFields()[NODE];
	  !node ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s.%s field in ' + 'document `%s`.', type, EDGES, NODE, definitionName) : invariant(false) : void 0;
	  var nodeType = SchemaUtils.getNullableType(node.type);
	  !(nodeType instanceof GraphQLInterfaceType || nodeType instanceof GraphQLUnionType || nodeType instanceof GraphQLObjectType) ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an %s.%s field' + 'for which the type is an interface, object, or union in document `%s`.', type, EDGES, NODE, definitionName) : invariant(false) : void 0;

	  var cursor = edgeType.getFields()[CURSOR];
	  !(cursor && SchemaUtils.getNullableType(cursor.type) instanceof GraphQLScalarType) ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s.%s field for which the type is a scalar in document `%s`.', type, EDGES, CURSOR, definitionName) : invariant(false) : void 0;

	  var pageInfo = typeFields[PAGE_INFO];
	  !pageInfo ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have a %s field ' + 'in document `%s`.', type, PAGE_INFO, definitionName) : invariant(false) : void 0;
	  var pageInfoType = SchemaUtils.getNullableType(pageInfo.type);
	  !(pageInfoType instanceof GraphQLObjectType) ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have a %s field for ' + 'which the type is an object in document `%s`.', type, PAGE_INFO, definitionName) : invariant(false) : void 0;
	  ...
	  [END_CURSOR, HAS_NEXT_PAGE, HAS_PREV_PAGE, START_CURSOR].forEach(function (fieldName) {
	    ...
	    !(pageInfoField && SchemaUtils.getNullableType(pageInfoField.type) instanceof GraphQLScalarType) ?  true ? invariant(false, 'RelayConnectionTransform: Expected type `%s` to have an ' + '%s field for which the type is an scalar in document `%s`.', pageInfo.type, fieldName, definitionName) : invariant(false) : void 0;
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(1);
	var nullthrows = __webpack_require__(22);
	...
	function createArgumentDefinitions(context, spreadUsesWithin, fragment) {
	  ...
	  while (nodesToVisit.length !== 0) {
	    var spreadUses = nullthrows(spreadUsesWithin.get(nodesToVisit.pop()));
	...
	function getDeferrableSpreadUses(context, spreadUsesWithin, node) {
	  ...
	  if (!deferrableSpreadUses) {
	    ...
	    try {
	      for (var _iterator3 = nullthrows(spreadUsesWithin.get(node))[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	function createDeferrableReference(context, spread) {
	  ...
	  !doTypesOverlap(schema, fragmentType, nodeType) ?  true ? invariant(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s since objects of ' + 'type %s can never also be of type Node.', spread.name, fragmentType) : invariant(false) : void 0;
	  !(spread.args.length === 0) ?  true ? invariant(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s with arguments.', spread.name) : invariant(false) : void 0;
	...
	function createDeferrableOperation(context, fragment) {
	  ...
	  !queryType ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: "Query" must be a defined type') : invariant(false) : void 0;
	  var nodeField = queryType.getFields().node;
	  !nodeField ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: "Query" must define the field "node"') : invariant(false) : void 0;
	  var idArg = nodeField.args.find(function (arg) {
	    return arg.name === 'id';
	  });
	  !(idArg && isInputType(idArg.type)) ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: "node" field must define the argument "id"') : invariant(false) : void 0;
	...
	function getNodeType(schema) {
	  ...
	  !(nodeType instanceof GraphQLInterfaceType) ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: Schema must define the interface "Node".') : invariant(false) : void 0;
	  return nodeType;
	}
	...
	function getIdType(schema) {
	  ...
	  !idField ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: "Node" must define the field "id"') : invariant(false) : void 0;
	  var idType = getNamedType(idField.type);
	  !isInputType(idType) ?  true ? invariant(false, 'RelayDeferrableFragmentTransform: "Node" must define the scalar field "id"') : invariant(false) : void 0;
	  return idType;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRelayHandleKey = __webpack_require__(81);
	var invariant = __webpack_require__(1);
	...
	function visitField(field) {
	  ...
	  !(handles.length === 1) ?  true ? invariant(false, 'RelayFieldHandleTransform: Expected fields to have at most one ' + '"handle" property, got `%s`.', handles.join(', ')) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayFlowGenerator = __webpack_require__(59);
	var RelayParser = __webpack_require__(19);
	var RelayValidator = __webpack_require__(66);
	...
	var invariant = __webpack_require__(1);
	var path = __webpack_require__(9);
	var writeRelayGeneratedFile = __webpack_require__(86);
	  ...
	  RelayFileWriter.prototype.writeAll = function writeAll() {
	    ...
	    return Profiler.asyncContext('RelayFileWriter.writeAll', (0, _asyncToGenerator3.default)(function* () {
	      ...
	      var getDefinitionMeta = function getDefinitionMeta(definitionName) {
	        ...
	        !definitionMeta ?  true ? invariant(false, 'RelayFileWriter: Could not determine source for definition: `%s`.', definitionName) : invariant(false) : void 0;
	        ...
	        doc.definitions.forEach(function (def) {
	          if (def.name) {
	            definitionsMeta.set(def.name.value, {
	              dir: path.join(_this._config.baseDir, path.dirname(filePath)),
	              ast: def
	            });
	          }
	        });
	      ...
	      var validationRules = [].concat((0, _toConsumableArray3['default'])(RelayValidator.LOCAL_RULES), (0, _toConsumableArray3['default'])(RelayValidator.GLOBAL_RULES));
	      ...
	      var definitions = ASTConvert.convertASTDocumentsWithBase(extendedSchema, _this._baseDocuments.valueSeq().toArray(), _this._documents.valueSeq().toArray(), validationRules, RelayParser.transform.bind(RelayParser));
	      ...
	      var transformedFlowContext = compilerContext.applyTransforms(RelayFlowGenerator.flowTransforms, _this._reporter);
	      ...
	      var artifacts = compileRelayArtifacts(compilerContext, _this._config.compilerTransforms, _this._reporter);
	      ...
	      try {
	        yield Promise.all(artifacts.map((() => {
	          var _ref3 = (0, _asyncToGenerator3.default)(function* (node) {
	            ...
	            !flowNode ?  true ? invariant(false, 'RelayFileWriter: did not compile flow types for: %s', node.name) : invariant(false) : void 0;

	            var flowTypes = RelayFlowGenerator.generate(flowNode, {
	            ...
	            var sourceHash = Profiler.run('hashGraphQL', function () {
	              return md5(graphql.print(getDefinitionMeta(node.name).ast));
	            });

	            yield writeRelayGeneratedFile(getGeneratedDirectory(node.name), node, formatModule, flowTypes, persistQuery, _this._config.platform, relayRuntimeModule, sourceHash);
	          });
	        ...
	        if (_generateExtraFiles) {
	          Profiler.run('RelayFileWriter:generateExtraFiles', function () {
	            ...
	            _generateExtraFiles(function (dir) {
	              ...
	              !outputDirectory ?  true ? invariant(false, 'RelayFileWriter: cannot generate extra files without specifying ' + 'an outputDir in the config or passing it in.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PatchedBabelGenerator = __webpack_require__(49);
	var RelayMaskTransform = __webpack_require__(32);
	var RelayRelayDirectiveTransform = __webpack_require__(33);
	...
	function makeProp(_ref, state, concreteType) {
	  ...
	  if (nodeType) {
	    value = transformScalarType(nodeType, state, selectionsToBabel([Array.from(nullthrows(nodeSelections).values())], state));
	  }
	  ...
	  return {
	    leave: {
	      Root: function Root(node) {
	        ...
	        return t.program([].concat((0, _toConsumableArray3['default'])(getFragmentImports(state)), (0, _toConsumableArray3['default'])(getEnumDefinitions(state)), [inputVariablesType, responseType]));
	      },
	      Fragment: function Fragment(node) {
	        ...
	        var refType = t.expressionStatement(t.identifier('declare export opaque type ' + refTypeName + ': FragmentReference'));
	        var baseType = selectionsToBabel(selections, state, refTypeName);
	        var type = isPlural(node) ? readOnlyArrayOfType(baseType) : baseType;
	        return t.program([].concat((0, _toConsumableArray3['default'])(getFragmentImports(state)), (0, _toConsumableArray3['default'])(getEnumDefinitions(state)), [importTypes(['FragmentReference'], state.relayRuntimeModule), refType, exportType(node.name, type)]));
	      },
	      InlineFragment: function InlineFragment(node) {
	...
	function groupRefs(props) {
	  ...
	  if (refs.length > 0) {
	    var _value3 = intersectionTypeAnnotation(refs.map(function (ref) {
	      return t.identifier(getRefTypeName(ref));
	    }));
	    result.push({
	      key: '$fragmentRefs',
	      conditional: false,
	...
	var FLOW_TRANSFORMS = [RelayRelayDirectiveTransform.transform, RelayMaskTransform.transform, FlattenTransform.transformWithOptions({})];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayApplyFragmentArgumentTransform = __webpack_require__(50);
	var RelayConnectionTransform = __webpack_require__(55);
	var RelayDeferrableFragmentTransform = __webpack_require__(56);
	var RelayFieldHandleTransform = __webpack_require__(57);
	var RelayGenerateIDFieldTransform = __webpack_require__(61);
	var RelayGenerateTypeNameTransform = __webpack_require__(62);
	var RelayMaskTransform = __webpack_require__(32);
	var RelayRelayDirectiveTransform = __webpack_require__(33);
	var RelaySkipHandleFieldTransform = __webpack_require__(65);
	var RelayViewerHandleTransform = __webpack_require__(67);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FindGraphQLTags = __webpack_require__(43);
	var GraphQL = __webpack_require__(3);
	...
	function parseFile(baseDir, file) {
	  ...
	  !(text.indexOf('graphql') >= 0) ?  true ? invariant(false, 'RelayJSModuleParser: Files should be filtered before passed to the ' + 'parser, got unfiltered file `%s`.', file) : invariant(false) : void 0;

	  var astDefinitions = [];
	  FindGraphQLTags.memoizedFind(text, baseDir, file, FIND_OPTIONS).forEach(function (template) {
	    var ast = parseGraphQL(new GraphQL.Source(template, file.relPath));
	    !ast.definitions.length ?  true ? invariant(false, 'RelayJSModuleParser: Expected GraphQL text to contain at least one ' + 'definition (fragment, mutation, query, subscription), got `%s`.', template) : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function visitField(field, parentType) {
	  ...
	  field.name === SchemaMetaFieldDef.name || field.name === TypeMetaFieldDef.name || field.name === TypeNameMetaFieldDef.name || field.directives.some(function (_ref) {
	    ...
	    !type ?  true ? invariant(false, 'SkipClientFieldTransform: Expected type `%s` to be defined in ' + 'the server schema.', rawType.name) : invariant(false) : void 0;
	...
	function transformNode(node, selectionMap) {
	  ...
	  sortSelections(node.selections).forEach(function (selection) {
	    ...
	    switch (selection.kind) {
	      ...
	      default:
	         true ?  true ? invariant(false, 'SkipRedundantNodesTransform: Unexpected node kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	  });
	...
	function transformNode(context, fragments, node) {
	  ...
	  while (queue.length) {
	    ...
	    switch (selection.kind) {
	      ...
	      default:
	        selection.kind;
	         true ?  true ? invariant(false, 'SkipUnreachableNodeTransform: Unexpected selection kind `%s`.', selection.kind) : invariant(false) : void 0;
	    }
	    if (nextSelection) {
	      selections = selections || [];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var childProcess = __webpack_require__(93);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function stripUnusedVariablesTransform(context) {
	  ...
	  rootToVariables.forEach(function (variables, root) {
	    Array.from(nullthrows(rootToFragmentSpreads.get(root), 'root ' + root + ' wasn\'t found in StripUnusedVariablesTransform')).forEach(function (spread) {
	  ...
	  return GraphQLIRTransformer.transform(context, {
	    Root: function Root(root) {
	      return transformRoot(context, root, nullthrows(rootToVariables.get(root.name), 'root ' + root.name + ' wasn\'t found in StripUnusedVariablesTransform'));
	    },
	...
	function allVariablesReferencedInFragment(variablesMemo, fragment, fragmentToVariables, fragmentToFragmentSpreads) {
	  ...
	  if (!variables) {
	    var directVariables = nullthrows(fragmentToVariables.get(fragment), 'fragment ' + fragment + ' wasn\'t found in StripUnusedVariablesTransform');
	    variables = Array.from(nullthrows(fragmentToFragmentSpreads.get(fragment), 'fragment ' + fragment + ' wasn\'t found in StripUnusedVariablesTransform')).reduce(function (allVariables, fragmentSpread) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getIdentifierForArgumentValue(value) {
	  switch (value.kind) {
	    ...
	    default:
	       true ?  true ? invariant(false, 'getIdentifierForArgumentValue(): Unsupported AST kind `%s`.', value.kind) : invariant(false) : void 0;
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getLiteralArgumentValues(args) {
	  var values = {};
	  args.forEach(function (arg) {
	    !(arg.value.kind === 'Literal') ?  true ? invariant(false, 'getLiteralArgumentValues(): Expected all args to be literals.') : invariant(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getModuleName(filePath) {
	  ...
	  var moduleName = filename === 'index' ? path.basename(path.dirname(filePath)) : filename;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let writeRelayGeneratedFile = (() => {
	  var _ref = (0, _asyncToGenerator3.default)(function* (codegenDir, generatedNode, formatModule, flowText, _persistQuery, platform, relayRuntimeModule, sourceHash) {
	        ...
	        switch (generatedNode.kind) {
	          case RelayConcreteNode.REQUEST:
	            ...
	            generatedNode = (0, _extends3['default'])({}, generatedNode, {
	              text: null,
	              id: yield persistQuery(nullthrows(generatedNode.text))
	            });
	            break;
	              ...
	              requests: yield Promise.all(generatedNode.requests.map((() => {
	                var _ref2 = (0, _asyncToGenerator3.default)(function* (request) {
	                  return (0, _extends3['default'])({}, request, {
	                    text: null,
	                    id: yield persistQuery(nullthrows(request.text))
	                  });
	                });
	    ...
	    var devOnlyAssignments = deepMergeAssignments('node', devOnlyProperties);
	...
	var RelayConcreteNode = __webpack_require__(53);

	var crypto = __webpack_require__(15);
	var dedupeJSONStringify = __webpack_require__(74);
	var deepMergeAssignments = __webpack_require__(75);
	var nullthrows = __webpack_require__(22);
